...
void RegisterAngelscriptObjects(asIScriptEngine *engine)
{
	...
	RegisterSharedPointer<IComponent>("ComponentPtr", "IComponent", engine);
...
// /*(const QString & (==const QString &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("SceneAPI", "ComponentPtr CreateComponentByName(Scene @,const QString &in,const QString &in) const", AS_METHOD_FUNCTION_PR(SceneAPI, CreateComponentByName, (Scene *,const QString &,const QString &) const, ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const QString & (==const QString &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("SceneAPI", "ComponentPtr CreateComponentById(Scene @,uint,const QString &in) const", AS_METHOD_FUNCTION_PR(SceneAPI, CreateComponentById, (Scene *,u32,const QString &) const, ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QString(==QString) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("SceneAPI", "QString GetComponentTypeName(uint) const", AS_METHOD_FUNCTION_PR(SceneAPI, GetComponentTypeName, (u32) const, QString), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const QString & (==const QString &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("SceneAPI", "uint GetComponentTypeId(const QString &in) const", AS_METHOD_FUNCTION_PR(SceneAPI, GetComponentTypeId, (const QString &) const, u32), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QString(==QString) is not known to angelscript)*/ 	//.classmethod(// /*(const QString & (==const QString &) is not known to angelscript)*/ 	//.classmethod(// /*(const QString & (==const QString &) is not known to angelscript)*/ 	//.classmethod(// /*(const QString & (==const QString &) is not known to angelscript)*/ 	//.classmethod(// /*(QStringList(==QStringList) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("SceneAPI", "QStringList ComponentTypes() const", AS_METHOD_FUNCTION_PR(SceneAPI, ComponentTypes, () const, QStringList), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(const QString & (==const QString &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "ComponentPtr CreateComponentWithId(uint,uint,const QString &in,AttributeChange_Type)", AS_METHOD_FUNCTION_PR(Entity, CreateComponentWithId, (component_id_t,u32,const QString &,AttributeChange::Type), ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(const ActionMap &(==const ActionMap &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "const ActionMap & Actions() const", AS_METHOD_FUNCTION_PR(Entity, Actions, () const, const ActionMap &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Entity", "ComponentPtr GetComponentById(uint) const", AS_METHOD_FUNCTION_PR(Entity, GetComponentById, (component_id_t) const, ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const QString & (==const QString &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "ComponentPtr GetComponent(const QString &in) const", AS_METHOD_FUNCTION_PR(Entity, GetComponent, (const QString &) const, ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Entity", "ComponentPtr GetComponent(uint) const", AS_METHOD_FUNCTION_PR(Entity, GetComponent, (u32) const, ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const QString & (==const QString &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "ComponentPtr GetComponent(const QString &in,const QString &in) const", AS_METHOD_FUNCTION_PR(Entity, GetComponent, (const QString &,const QString &) const, ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const QString & (==const QString &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "ComponentPtr GetComponent(uint,const QString &in) const", AS_METHOD_FUNCTION_PR(Entity, GetComponent, (u32,const QString &) const, ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const QString & (==const QString &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "ComponentPtr GetOrCreateComponent(const QString &in,AttributeChange_Type,bool)", AS_METHOD_FUNCTION_PR(Entity, GetOrCreateComponent, (const QString &,AttributeChange::Type,bool), ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const QString & (==const QString &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "ComponentPtr GetOrCreateComponent(const QString &in,const QString &in,AttributeChange_Type,bool)", AS_METHOD_FUNCTION_PR(Entity, GetOrCreateComponent, (const QString &,const QString &,AttributeChange::Type,bool), ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Entity", "ComponentPtr GetOrCreateComponent(uint,AttributeChange_Type,bool)", AS_METHOD_FUNCTION_PR(Entity, GetOrCreateComponent, (u32,AttributeChange::Type,bool), ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const QString & (==const QString &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "ComponentPtr GetOrCreateComponent(uint,const QString &in,AttributeChange_Type,bool)", AS_METHOD_FUNCTION_PR(Entity, GetOrCreateComponent, (u32,const QString &,AttributeChange::Type,bool), ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const QString & (==const QString &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "ComponentPtr GetOrCreateLocalComponent(const QString &in)", AS_METHOD_FUNCTION_PR(Entity, GetOrCreateLocalComponent, (const QString &), ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const QString & (==const QString &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "ComponentPtr GetOrCreateLocalComponent(const QString &in,const QString &in)", AS_METHOD_FUNCTION_PR(Entity, GetOrCreateLocalComponent, (const QString &,const QString &), ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const QString & (==const QString &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "ComponentPtr CreateComponent(const QString &in,AttributeChange_Type,bool)", AS_METHOD_FUNCTION_PR(Entity, CreateComponent, (const QString &,AttributeChange::Type,bool), ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const QString & (==const QString &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "ComponentPtr CreateComponent(const QString &in,const QString &in,AttributeChange_Type,bool)", AS_METHOD_FUNCTION_PR(Entity, CreateComponent, (const QString &,const QString &,AttributeChange::Type,bool), ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Entity", "ComponentPtr CreateComponent(uint,AttributeChange_Type,bool)", AS_METHOD_FUNCTION_PR(Entity, CreateComponent, (u32,AttributeChange::Type,bool), ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const QString & (==const QString &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "ComponentPtr CreateComponent(uint,const QString &in,AttributeChange_Type,bool)", AS_METHOD_FUNCTION_PR(Entity, CreateComponent, (u32,const QString &,AttributeChange::Type,bool), ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const QString & (==const QString &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "ComponentPtr CreateLocalComponent(const QString &in)", AS_METHOD_FUNCTION_PR(Entity, CreateLocalComponent, (const QString &), ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const QString & (==const QString &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "ComponentPtr CreateLocalComponent(const QString &in,const QString &in)", AS_METHOD_FUNCTION_PR(Entity, CreateLocalComponent, (const QString &,const QString &), ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Entity", "void AddComponent(const ComponentPtr &in,AttributeChange_Type)", AS_METHOD_FUNCTION_PR(Entity, AddComponent, (const ComponentPtr &,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Entity", "void AddComponent(uint,const ComponentPtr &in,AttributeChange_Type)", AS_METHOD_FUNCTION_PR(Entity, AddComponent, (component_id_t,const ComponentPtr &,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Entity", "void RemoveComponent(const ComponentPtr &in,AttributeChange_Type)", AS_METHOD_FUNCTION_PR(Entity, RemoveComponent, (const ComponentPtr &,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(ComponentMap(==std_map<component_id_t, ComponentPtr>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "std_map<component_id_t, ComponentPtr> Components()", AS_METHOD_FUNCTION_PR(Entity, Components, (), ComponentMap), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	...
	r = engine->RegisterObjectMethod("IComponent", "uint TypeId() const", AS_METHOD_FUNCTION_PR(IComponent, TypeId, () const, u32), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(const QString & (==const QString &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("IComponent", "IAttribute @ CreateAttribute(uint8,uint,const QString &in,AttributeChange_Type)", AS_METHOD_FUNCTION_PR(IComponent, CreateAttribute, (u8,u32,const QString &,AttributeChange::Type), IAttribute *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(const QString &(==const QString &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("IAttribute", "const QString & TypeName() const", AS_METHOD_FUNCTION_PR(IAttribute, TypeName, () const, const QString &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("IAttribute", "uint TypeId() const", AS_METHOD_FUNCTION_PR(IAttribute, TypeId, () const, u32), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(inout refs are not supported for value types)*/ 	r = engine->RegisterObjectMethod("Triangle", "float3 RandomPointOnEdge(LCG &) const", AS_METHOD_FUNCTION_PR(Triangle, RandomPointOnEdge, (LCG &) const, float3), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	...
	//.classmethod(	//.classmethod(	//.classmethod(	//.classmethod(	//.classmethod(	//.classmethod(	//.classmethod(	//.classmethod(	//.classmethod(	//.classmethod(	//.classmethod(	//.classmethod(	//.classmethod(	//.classmethod(	//.classmethod(	//.classmethod(	//.classmethod(	//.classmethod(	//.classmethod(	//.classmethod(	//.classmethod(	//.classmethod(	//.classmethod(	//.classmethod(	//.classmethod(	//.classmethod(	//.classmethod(
	...
	r = engine->RegisterObjectBehaviour("LCG", asBEHAVE_CONSTRUCT, "void f(uint,uint,uint,uint)", AS_CONSTRUCTOR(LCG_ctor_u32_u32_u32_u32, LCG, (u32,u32,u32,u32)), AS_CTOR_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("LCG", "void Seed(uint,uint,uint,uint)", AS_METHOD_FUNCTION_PR(LCG, Seed, (u32,u32,u32,u32), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("LCG", "uint Int()", AS_METHOD_FUNCTION_PR(LCG, Int, (), u32), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("LCG", "uint MaxInt() const", AS_METHOD_FUNCTION_PR(LCG, MaxInt, () const, u32), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("LCG", "uint IntFast()", AS_METHOD_FUNCTION_PR(LCG, IntFast, (), u32), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
