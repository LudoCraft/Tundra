...
// /*(const float *(==const float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float2", "const float * ptr() const", AS_METHOD_FUNCTION_PR(float2, ptr, () const, const float *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("float2", "float & operator[](int)", AS_METHOD_FUNCTION_PR(float2, operator[], (int), float &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(CONST_WIN32 float(==CONST_WIN32 float) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float2", "CONST_WIN32 float operator[](int) const", AS_METHOD_FUNCTION_PR(float2, operator[], (int) const, CONST_WIN32 float), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(const float *(==const float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float3", "const float * ptr() const", AS_METHOD_FUNCTION_PR(float3, ptr, () const, const float *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("float3", "float & operator[](int)", AS_METHOD_FUNCTION_PR(float3, operator[], (int), float &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(CONST_WIN32 float(==CONST_WIN32 float) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float3", "CONST_WIN32 float operator[](int) const", AS_METHOD_FUNCTION_PR(float3, operator[], (int) const, CONST_WIN32 float), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(const float *(==const float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float4", "const float * ptr() const", AS_METHOD_FUNCTION_PR(float4, ptr, () const, const float *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("float4", "float & operator[](int)", AS_METHOD_FUNCTION_PR(float4, operator[], (int), float &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(CONST_WIN32 float(==CONST_WIN32 float) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float4", "CONST_WIN32 float operator[](int) const", AS_METHOD_FUNCTION_PR(float4, operator[], (int) const, CONST_WIN32 float), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(MatrixProxy < Cols > &(==MatrixProxy < Cols > &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float3x3", "MatrixProxy < Cols > & operator[](int)", AS_METHOD_FUNCTION_PR(float3x3, operator[], (int), MatrixProxy < Cols > &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const MatrixProxy < Cols > &(==const MatrixProxy < Cols > &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float3x3", "const MatrixProxy < Cols > & operator[](int) const", AS_METHOD_FUNCTION_PR(float3x3, operator[], (int) const, const MatrixProxy < Cols > &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(const float * (==const float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float3x3", "void Set(const float *)", AS_METHOD_FUNCTION_PR(float3x3, Set, (const float *), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	...
	r = engine->RegisterObjectMethod("float3x3", "float3x3 & operator=(const Quat &in)", AS_METHOD_FUNCTION_PR(float3x3, operator=, (const Quat &), float3x3 &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("float3x3", "float3x3 & operator=(const float3x3 &in)", AS_METHOD_FUNCTION_PR(float3x3, operator=, (const float3x3 &), float3x3 &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(MatrixProxy < Cols > &(==MatrixProxy < Cols > &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float3x4", "MatrixProxy < Cols > & operator[](int)", AS_METHOD_FUNCTION_PR(float3x4, operator[], (int), MatrixProxy < Cols > &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const MatrixProxy < Cols > &(==const MatrixProxy < Cols > &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float3x4", "const MatrixProxy < Cols > & operator[](int) const", AS_METHOD_FUNCTION_PR(float3x4, operator[], (int) const, const MatrixProxy < Cols > &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(const float * (==const float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float3x4", "void Set(const float *)", AS_METHOD_FUNCTION_PR(float3x4, Set, (const float *), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	...
	r = engine->RegisterObjectMethod("float3x4", "float3x4 & operator=(const float3x3 &in)", AS_METHOD_FUNCTION_PR(float3x4, operator=, (const float3x3 &), float3x4 &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("float3x4", "float3x4 & operator=(const Quat &in)", AS_METHOD_FUNCTION_PR(float3x4, operator=, (const Quat &), float3x4 &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("float3x4", "float3x4 & operator=(const float3x4 &in)", AS_METHOD_FUNCTION_PR(float3x4, operator=, (const float3x4 &), float3x4 &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(MatrixProxy < Cols > &(==MatrixProxy < Cols > &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float4x4", "MatrixProxy < Cols > & operator[](int)", AS_METHOD_FUNCTION_PR(float4x4, operator[], (int), MatrixProxy < Cols > &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const MatrixProxy < Cols > &(==const MatrixProxy < Cols > &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float4x4", "const MatrixProxy < Cols > & operator[](int) const", AS_METHOD_FUNCTION_PR(float4x4, operator[], (int) const, const MatrixProxy < Cols > &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(const float * (==const float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float4x4", "void Set(const float *)", AS_METHOD_FUNCTION_PR(float4x4, Set, (const float *), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	...
	r = engine->RegisterObjectMethod("float4x4", "float4x4 & operator=(const float3x3 &in)", AS_METHOD_FUNCTION_PR(float4x4, operator=, (const float3x3 &), float4x4 &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("float4x4", "float4x4 & operator=(const float3x4 &in)", AS_METHOD_FUNCTION_PR(float4x4, operator=, (const float3x4 &), float4x4 &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("float4x4", "float4x4 & operator=(const float4x4 &in)", AS_METHOD_FUNCTION_PR(float4x4, operator=, (const float4x4 &), float4x4 &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("float4x4", "float4x4 & operator=(const Quat &in)", AS_METHOD_FUNCTION_PR(float4x4, operator=, (const Quat &), float4x4 &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
