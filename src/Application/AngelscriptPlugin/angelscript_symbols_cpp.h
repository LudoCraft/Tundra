...
{
	((EC_Placeable*)memory)->~EC_Placeable();
}

static void Transform_ctor_(Transform *self)
{
	new(self) Transform();
}

static void Transform_ctor_const_float3_ref_const_float3_ref_const_float3_ref(const float3 & pos_,const float3 & rot_,const float3 & scale_, Transform *self)
{
	new(self) Transform(pos_,rot_,scale_);
}

static void Transform_ctor_const_float3x3_ref(const float3x3 & m, Transform *self)
{
	new(self) Transform(m);
}

static void Transform_ctor_const_float3x4_ref(const float3x4 & m, Transform *self)
{
	new(self) Transform(m);
}

static void Transform_ctor_const_float4x4_ref(const float4x4 & m, Transform *self)
{
	new(self) Transform(m);
}
...
void RegisterAngelscriptObjects(asIScriptEngine *engine)
{
	...
	r = engine->RegisterObjectType("Framework", sizeof(Framework), asOBJ_REF | asOBJ_NOCOUNT); assert(r >= 0);
	r = engine->RegisterObjectType("SceneAPI", sizeof(SceneAPI), asOBJ_REF | asOBJ_NOCOUNT); assert(r >= 0);
	r = engine->RegisterObjectType("Scene", sizeof(Scene), asOBJ_REF | asOBJ_NOCOUNT); assert(r >= 0);
	r = engine->RegisterObjectType("Entity", sizeof(Entity), asOBJ_REF | asOBJ_NOCOUNT); assert(r >= 0);
	r = engine->RegisterObjectType("IComponent", sizeof(IComponent), asOBJ_REF | asOBJ_NOCOUNT); assert(r >= 0);
	r = engine->RegisterObjectType("IAttribute", sizeof(IAttribute), asOBJ_REF | asOBJ_NOCOUNT); assert(r >= 0);
	r = engine->RegisterObjectType("float2", sizeof(float2), asOBJ_VALUE | asOBJ_POD | asOBJ_APP_CLASS | asOBJ_APP_CLASS_CONSTRUCTOR | asOBJ_APP_CLASS_COPY_CONSTRUCTOR); assert(r >= 0);
	r = engine->RegisterObjectType("float3", sizeof(float3), asOBJ_VALUE | asOBJ_POD | asOBJ_APP_CLASS | asOBJ_APP_CLASS_CONSTRUCTOR | asOBJ_APP_CLASS_COPY_CONSTRUCTOR); assert(r >= 0);
	r = engine->RegisterObjectType("float4", sizeof(float4), asOBJ_VALUE | asOBJ_POD | asOBJ_APP_CLASS | asOBJ_APP_CLASS_CONSTRUCTOR | asOBJ_APP_CLASS_COPY_CONSTRUCTOR); assert(r >= 0);
	r = engine->RegisterObjectType("float3x3", sizeof(float3x3), asOBJ_VALUE | asOBJ_POD | asOBJ_APP_CLASS | asOBJ_APP_CLASS_CONSTRUCTOR | asOBJ_APP_CLASS_COPY_CONSTRUCTOR | asOBJ_APP_CLASS_ASSIGNMENT); assert(r >= 0);
	r = engine->RegisterObjectType("float3x4", sizeof(float3x4), asOBJ_VALUE | asOBJ_POD | asOBJ_APP_CLASS | asOBJ_APP_CLASS_CONSTRUCTOR | asOBJ_APP_CLASS_COPY_CONSTRUCTOR | asOBJ_APP_CLASS_ASSIGNMENT); assert(r >= 0);
	r = engine->RegisterObjectType("float4x4", sizeof(float4x4), asOBJ_VALUE | asOBJ_POD | asOBJ_APP_CLASS | asOBJ_APP_CLASS_CONSTRUCTOR | asOBJ_APP_CLASS_COPY_CONSTRUCTOR | asOBJ_APP_CLASS_ASSIGNMENT); assert(r >= 0);
	r = engine->RegisterObjectType("Quat", sizeof(Quat), asOBJ_VALUE | asOBJ_POD | asOBJ_APP_CLASS | asOBJ_APP_CLASS_CONSTRUCTOR | asOBJ_APP_CLASS_COPY_CONSTRUCTOR); assert(r >= 0);
	r = engine->RegisterObjectType("TranslateOp", sizeof(TranslateOp), asOBJ_VALUE | asOBJ_POD | asOBJ_APP_CLASS | asOBJ_APP_CLASS_CONSTRUCTOR); assert(r >= 0);
	r = engine->RegisterObjectType("ScaleOp", sizeof(ScaleOp), asOBJ_VALUE | asOBJ_POD | asOBJ_APP_CLASS | asOBJ_APP_CLASS_CONSTRUCTOR); assert(r >= 0);
	r = engine->RegisterObjectType("AABB", sizeof(AABB), asOBJ_VALUE | asOBJ_POD | asOBJ_APP_CLASS | asOBJ_APP_CLASS_CONSTRUCTOR); assert(r >= 0);
	r = engine->RegisterObjectType("Capsule", sizeof(Capsule), asOBJ_VALUE | asOBJ_POD | asOBJ_APP_CLASS | asOBJ_APP_CLASS_CONSTRUCTOR); assert(r >= 0);
	r = engine->RegisterObjectType("Circle", sizeof(Circle), asOBJ_VALUE | asOBJ_POD | asOBJ_APP_CLASS | asOBJ_APP_CLASS_CONSTRUCTOR); assert(r >= 0);
	r = engine->RegisterObjectType("Frustum", sizeof(Frustum), asOBJ_VALUE | asOBJ_POD | asOBJ_APP_CLASS | asOBJ_APP_CLASS_CONSTRUCTOR); assert(r >= 0);
	r = engine->RegisterObjectType("Line", sizeof(Line), asOBJ_VALUE | asOBJ_POD | asOBJ_APP_CLASS | asOBJ_APP_CLASS_CONSTRUCTOR); assert(r >= 0);
	r = engine->RegisterObjectType("LineSegment", sizeof(LineSegment), asOBJ_VALUE | asOBJ_POD | asOBJ_APP_CLASS | asOBJ_APP_CLASS_CONSTRUCTOR); assert(r >= 0);
	r = engine->RegisterObjectType("OBB", sizeof(OBB), asOBJ_VALUE | asOBJ_POD | asOBJ_APP_CLASS | asOBJ_APP_CLASS_CONSTRUCTOR); assert(r >= 0);
	r = engine->RegisterObjectType("Plane", sizeof(Plane), asOBJ_VALUE | asOBJ_POD | asOBJ_APP_CLASS | asOBJ_APP_CLASS_CONSTRUCTOR); assert(r >= 0);
	r = engine->RegisterObjectType("Ray", sizeof(Ray), asOBJ_VALUE | asOBJ_POD | asOBJ_APP_CLASS | asOBJ_APP_CLASS_CONSTRUCTOR); assert(r >= 0);
	r = engine->RegisterObjectType("Sphere", sizeof(Sphere), asOBJ_VALUE | asOBJ_POD | asOBJ_APP_CLASS | asOBJ_APP_CLASS_CONSTRUCTOR); assert(r >= 0);
	...
	r = engine->RegisterObjectType("Transform", sizeof(Transform), asOBJ_VALUE | asOBJ_POD | asOBJ_APP_CLASS | asOBJ_APP_CLASS_CONSTRUCTOR); assert(r >= 0);
	RegisterSharedPointer<Entity>("EntityPtr", "Entity", engine);
	RegisterSharedPointer<Scene>("ScenePtr", "Scene", engine);
	r = engine->RegisterEnum("AttributeChange_Type"); assert(r >= 0);
	r = engine->RegisterEnumValue("AttributeChange_Type", "Default", 0); assert(r >= 0);
	r = engine->RegisterEnumValue("AttributeChange_Type", "Disconnected", 1); assert(r >= 0);
	r = engine->RegisterEnumValue("AttributeChange_Type", "LocalOnly", 2); assert(r >= 0);
	r = engine->RegisterEnumValue("AttributeChange_Type", "Replicate", 3); assert(r >= 0);


// /*(char ** (==int8 **) is not known to angelscript)*/ 	// /* TODO */ r = engine->RegisterObjectBehaviour("Framework", asBEHAVE_FACTORY, "Framework@ f(int,int8 **)", AS_FUNCTION(Framework_Factory_int_char_ptrptr, Framework, (int,char **)), AS_CALL_CONVENTION); assert(r >= 0);		r = engine->RegisterObjectMethod("Framework", "void Go()", AS_METHOD_FUNCTION_PR(Framework, Go, (), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(T *(==T *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Framework", "T * GetModule() const", AS_METHOD_FUNCTION_PR(Framework, GetModule, () const, T *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(IModule * (==IModule @) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Framework", "void RegisterModule(IModule @)", AS_METHOD_FUNCTION_PR(Framework, RegisterModule, (IModule *), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QString (==QString) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Framework", "bool RegisterDynamicObject(QString,QObject *)", AS_METHOD_FUNCTION_PR(Framework, RegisterDynamicObject, (QString,QObject *), bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(Application *(==Application @) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Framework", "Application @ App() const", AS_METHOD_FUNCTION_PR(Framework, App, () const, Application *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(IRenderer * (==IRenderer @) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Framework", "void RegisterRenderer(IRenderer @)", AS_METHOD_FUNCTION_PR(Framework, RegisterRenderer, (IRenderer *), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(IRenderer *(==IRenderer @) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Framework", "IRenderer @ Renderer() const", AS_METHOD_FUNCTION_PR(Framework, Renderer, () const, IRenderer *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	//.classmethod(	//.classmethod(// /*(StaticPluginRegistry *(==StaticPluginRegistry *) is not known to angelscript)*/ 	//.classmethod(// /*(UiAPI *(==UiAPI @) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Framework", "UiAPI @ Ui() const", AS_METHOD_FUNCTION_PR(Framework, Ui, () const, UiAPI *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(InputAPI *(==InputAPI @) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Framework", "InputAPI @ Input() const", AS_METHOD_FUNCTION_PR(Framework, Input, () const, InputAPI *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(FrameAPI *(==FrameAPI @) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Framework", "FrameAPI @ Frame() const", AS_METHOD_FUNCTION_PR(Framework, Frame, () const, FrameAPI *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ConsoleAPI *(==ConsoleAPI @) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Framework", "ConsoleAPI @ Console() const", AS_METHOD_FUNCTION_PR(Framework, Console, () const, ConsoleAPI *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(AudioAPI *(==AudioAPI @) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Framework", "AudioAPI @ Audio() const", AS_METHOD_FUNCTION_PR(Framework, Audio, () const, AudioAPI *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(AssetAPI *(==AssetAPI @) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Framework", "AssetAPI @ Asset() const", AS_METHOD_FUNCTION_PR(Framework, Asset, () const, AssetAPI *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Framework", "SceneAPI @ Scene() const", AS_METHOD_FUNCTION_PR(Framework, Scene, () const, SceneAPI *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ConfigAPI *(==ConfigAPI @) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Framework", "ConfigAPI @ Config() const", AS_METHOD_FUNCTION_PR(Framework, Config, () const, ConfigAPI *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(PluginAPI *(==PluginAPI *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Framework", "PluginAPI * Plugins() const", AS_METHOD_FUNCTION_PR(Framework, Plugins, () const, PluginAPI *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(VersionInfo *(==VersionInfo *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Framework", "VersionInfo * ApiVersion() const", AS_METHOD_FUNCTION_PR(Framework, ApiVersion, () const, VersionInfo *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(VersionInfo *(==VersionInfo *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Framework", "VersionInfo * ApplicationVersion() const", AS_METHOD_FUNCTION_PR(Framework, ApplicationVersion, () const, VersionInfo *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(IModule *(==IModule @) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Framework", "IModule @ GetModuleByName(const QString &in) const", AS_METHOD_FUNCTION_PR(Framework, GetModuleByName, (const QString &) const, IModule *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Framework", "bool IsHeadless() const", AS_METHOD_FUNCTION_PR(Framework, IsHeadless, () const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Framework", "void Exit()", AS_METHOD_FUNCTION_PR(Framework, Exit, (), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Framework", "bool IsExiting() const", AS_METHOD_FUNCTION_PR(Framework, IsExiting, () const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const QString & (==const QString &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Framework", "bool HasCommandLineParameter(const QString &in) const", AS_METHOD_FUNCTION_PR(Framework, HasCommandLineParameter, (const QString &) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QStringList(==QStringList) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Framework", "QStringList CommandLineParameters(const QString &in) const", AS_METHOD_FUNCTION_PR(Framework, CommandLineParameters, (const QString &) const, QStringList), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Framework", "void PrintStartupOptions()", AS_METHOD_FUNCTION_PR(Framework, PrintStartupOptions, (), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Framework", "void PrintDynamicObjects()", AS_METHOD_FUNCTION_PR(Framework, PrintDynamicObjects, (), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);



	// /*(boost::shared_ptr< T >(==boost_shared_ptr< T >) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("SceneAPI", "boost_shared_ptr< T > CreateComponent(Scene @,const QString &in) const", AS_METHOD_FUNCTION_PR(SceneAPI, CreateComponent, (Scene *,const QString &) const, boost::shared_ptr< T >), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(SceneMap &(==SceneMap &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("SceneAPI", "SceneMap & Scenes()", AS_METHOD_FUNCTION_PR(SceneAPI, Scenes, (), SceneMap &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const SceneMap &(==const SceneMap &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("SceneAPI", "const SceneMap & Scenes() const", AS_METHOD_FUNCTION_PR(SceneAPI, Scenes, () const, const SceneMap &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const QStringList &(==const QStringList &) is not known to angelscript)*/ 	//.classmethod(// /*(const QString & (==const QString &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("SceneAPI", "ScenePtr GetScene(const QString &in) const", AS_METHOD_FUNCTION_PR(SceneAPI, GetScene, (const QString &) const, ScenePtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("SceneAPI", "Scene @ MainCameraScene()", AS_METHOD_FUNCTION_PR(SceneAPI, MainCameraScene, (), Scene *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const QString & (==const QString &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("SceneAPI", "ScenePtr CreateScene(const QString &in,bool,bool)", AS_METHOD_FUNCTION_PR(SceneAPI, CreateScene, (const QString &,bool,bool), ScenePtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const QString & (==const QString &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("SceneAPI", "void RemoveScene(const QString &in)", AS_METHOD_FUNCTION_PR(SceneAPI, RemoveScene, (const QString &), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const QString & (==const QString &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("SceneAPI", "bool IsComponentFactoryRegistered(const QString &in) const", AS_METHOD_FUNCTION_PR(SceneAPI, IsComponentFactoryRegistered, (const QString &) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const ComponentFactoryPtr & (==const ComponentFactoryPtr &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("SceneAPI", "void RegisterComponentFactory(const ComponentFactoryPtr &in)", AS_METHOD_FUNCTION_PR(SceneAPI, RegisterComponentFactory, (const ComponentFactoryPtr &), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ComponentPtr(==boost_shared_ptr<IComponent>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("SceneAPI", "boost_shared_ptr<IComponent> CreateComponentByName(Scene @,const QString &in,const QString &in) const", AS_METHOD_FUNCTION_PR(SceneAPI, CreateComponentByName, (Scene *,const QString &,const QString &) const, ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ComponentPtr(==boost_shared_ptr<IComponent>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("SceneAPI", "boost_shared_ptr<IComponent> CreateComponentById(Scene @,boost_uint32_t,const QString &in) const", AS_METHOD_FUNCTION_PR(SceneAPI, CreateComponentById, (Scene *,u32,const QString &) const, ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QString(==QString) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("SceneAPI", "QString GetComponentTypeName(boost_uint32_t) const", AS_METHOD_FUNCTION_PR(SceneAPI, GetComponentTypeName, (u32) const, QString), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(u32(==boost_uint32_t) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("SceneAPI", "boost_uint32_t GetComponentTypeId(const QString &in) const", AS_METHOD_FUNCTION_PR(SceneAPI, GetComponentTypeId, (const QString &) const, u32), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QString(==QString) is not known to angelscript)*/ 	//.classmethod(// /*(u32(==boost_uint32_t) is not known to angelscript)*/ 	//.classmethod(// /*(u32 (==boost_uint32_t) is not known to angelscript)*/ 	//.classmethod(// /*(const QString & (==const QString &) is not known to angelscript)*/ 	//.classmethod(// /*(QStringList(==QStringList) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("SceneAPI", "QStringList ComponentTypes() const", AS_METHOD_FUNCTION_PR(SceneAPI, ComponentTypes, () const, QStringList), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const QString & (==const QString &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("SceneAPI", "bool HasScene(const QString &in) const", AS_METHOD_FUNCTION_PR(SceneAPI, HasScene, (const QString &) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);



	// /*(const QString &(==const QString &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "const QString & Name() const", AS_METHOD_FUNCTION_PR(Scene, Name, () const, const QString &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(iterator(==EntityMap_iterator) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "EntityMap_iterator begin()", AS_METHOD_FUNCTION_PR(Scene, begin, (), iterator), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(iterator(==EntityMap_iterator) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "EntityMap_iterator end()", AS_METHOD_FUNCTION_PR(Scene, end, (), iterator), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const_iterator(==EntityMap_const_iterator) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "EntityMap_const_iterator begin() const", AS_METHOD_FUNCTION_PR(Scene, begin, () const, const_iterator), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const_iterator(==EntityMap_const_iterator) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "EntityMap_const_iterator end() const", AS_METHOD_FUNCTION_PR(Scene, end, () const, const_iterator), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const EntityMap &(==const EntityMap &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "const EntityMap & Entities() const", AS_METHOD_FUNCTION_PR(Scene, Entities, () const, const EntityMap &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(boost::shared_ptr< T >(==boost_shared_ptr< T >) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "boost_shared_ptr< T > GetWorld() const", AS_METHOD_FUNCTION_PR(Scene, GetWorld, () const, boost::shared_ptr< T >), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Scene", "void ChangeEntityId(uint,uint)", AS_METHOD_FUNCTION_PR(Scene, ChangeEntityId, (entity_id_t,entity_id_t), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Scene", "bool StartAttributeInterpolation(IAttribute @,IAttribute @,float)", AS_METHOD_FUNCTION_PR(Scene, StartAttributeInterpolation, (IAttribute *,IAttribute *,float), bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Scene", "bool EndAttributeInterpolation(IAttribute @)", AS_METHOD_FUNCTION_PR(Scene, EndAttributeInterpolation, (IAttribute *), bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	...
	r = engine->RegisterObjectMethod("Scene", "Framework @ GetFramework() const", AS_METHOD_FUNCTION_PR(Scene, GetFramework, () const, Framework *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(SceneDesc(==SceneDesc) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "SceneDesc CreateSceneDescFromXml(const QString &in) const", AS_METHOD_FUNCTION_PR(Scene, CreateSceneDescFromXml, (const QString &) const, SceneDesc), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(SceneDesc(==SceneDesc) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "SceneDesc CreateSceneDescFromBinary(const QString &in) const", AS_METHOD_FUNCTION_PR(Scene, CreateSceneDescFromBinary, (const QString &) const, SceneDesc), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(QList< Entity * >(==QList< Entity * >) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "QList< Entity * > CreateContentFromSceneDesc(const SceneDesc &in,bool,AttributeChange_Type)", AS_METHOD_FUNCTION_PR(Scene, CreateContentFromSceneDesc, (const SceneDesc &,bool,AttributeChange::Type), QList< Entity * >), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Scene", "void EmitAttributeChanged(IComponent @,IAttribute @,AttributeChange_Type)", AS_METHOD_FUNCTION_PR(Scene, EmitAttributeChanged, (IComponent *,IAttribute *,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Scene", "void EmitAttributeAdded(IComponent @,IAttribute @,AttributeChange_Type)", AS_METHOD_FUNCTION_PR(Scene, EmitAttributeAdded, (IComponent *,IAttribute *,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Scene", "void EmitAttributeRemoved(IComponent @,IAttribute @,AttributeChange_Type)", AS_METHOD_FUNCTION_PR(Scene, EmitAttributeRemoved, (IComponent *,IAttribute *,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Scene", "void EmitComponentAdded(Entity @,IComponent @,AttributeChange_Type)", AS_METHOD_FUNCTION_PR(Scene, EmitComponentAdded, (Entity *,IComponent *,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Scene", "void EmitComponentRemoved(Entity @,IComponent @,AttributeChange_Type)", AS_METHOD_FUNCTION_PR(Scene, EmitComponentRemoved, (Entity *,IComponent *,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Scene", "void EmitEntityRemoved(Entity @,AttributeChange_Type)", AS_METHOD_FUNCTION_PR(Scene, EmitEntityRemoved, (Entity *,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const QString & (==const QString &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "void EmitActionTriggered(Entity @,const QString &in,const QStringList &in,EntityAction_ExecTypeField)", AS_METHOD_FUNCTION_PR(Scene, EmitActionTriggered, (Entity *,const QString &,const QStringList &,EntityAction::ExecTypeField), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Scene", "void EmitEntityAcked(Entity @,uint)", AS_METHOD_FUNCTION_PR(Scene, EmitEntityAcked, (Entity *,entity_id_t), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Scene", "void EmitComponentAcked(IComponent @,uint)", AS_METHOD_FUNCTION_PR(Scene, EmitComponentAcked, (IComponent *,component_id_t), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const QStringList & (==const QStringList &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "EntityPtr CreateEntity(uint,const QStringList &in,AttributeChange_Type,bool,bool)", AS_METHOD_FUNCTION_PR(Scene, CreateEntity, (entity_id_t,const QStringList &,AttributeChange::Type,bool,bool), EntityPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const QStringList & (==const QStringList &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "EntityPtr CreateLocalEntity(const QStringList &in,AttributeChange_Type,bool)", AS_METHOD_FUNCTION_PR(Scene, CreateLocalEntity, (const QStringList &,AttributeChange::Type,bool), EntityPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Scene", "float3 UpVector() const", AS_METHOD_FUNCTION_PR(Scene, UpVector, () const, float3), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Scene", "float3 RightVector() const", AS_METHOD_FUNCTION_PR(Scene, RightVector, () const, float3), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Scene", "float3 ForwardVector() const", AS_METHOD_FUNCTION_PR(Scene, ForwardVector, () const, float3), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Scene", "bool ViewEnabled() const", AS_METHOD_FUNCTION_PR(Scene, ViewEnabled, () const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Scene", "bool IsAuthority() const", AS_METHOD_FUNCTION_PR(Scene, IsAuthority, () const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Scene", "EntityPtr EntityById(uint) const", AS_METHOD_FUNCTION_PR(Scene, EntityById, (entity_id_t) const, EntityPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const QString & (==const QString &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "EntityPtr EntityByName(const QString &in) const", AS_METHOD_FUNCTION_PR(Scene, EntityByName, (const QString &) const, EntityPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const QString & (==const QString &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "bool IsUniqueName(const QString &in) const", AS_METHOD_FUNCTION_PR(Scene, IsUniqueName, (const QString &) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Scene", "bool HasEntity(uint) const", AS_METHOD_FUNCTION_PR(Scene, HasEntity, (entity_id_t) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Scene", "bool RemoveEntity(uint,AttributeChange_Type)", AS_METHOD_FUNCTION_PR(Scene, RemoveEntity, (entity_id_t,AttributeChange::Type), bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Scene", "void RemoveAllEntities(bool,AttributeChange_Type)", AS_METHOD_FUNCTION_PR(Scene, RemoveAllEntities, (bool,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Scene", "uint NextFreeId()", AS_METHOD_FUNCTION_PR(Scene, NextFreeId, (), entity_id_t), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Scene", "uint NextFreeIdLocal()", AS_METHOD_FUNCTION_PR(Scene, NextFreeIdLocal, (), entity_id_t), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(EntityList(==std_list<EntityPtr>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "std_list<EntityPtr> EntitiesWithComponent(const QString &in,const QString &in) const", AS_METHOD_FUNCTION_PR(Scene, EntitiesWithComponent, (const QString &,const QString &) const, EntityList), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(EntityList(==std_list<EntityPtr>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "std_list<EntityPtr> FindEntities(const QRegExp &in) const", AS_METHOD_FUNCTION_PR(Scene, FindEntities, (const QRegExp &) const, EntityList), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(EntityList(==std_list<EntityPtr>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "std_list<EntityPtr> FindEntities(const QString &in) const", AS_METHOD_FUNCTION_PR(Scene, FindEntities, (const QString &) const, EntityList), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(EntityList(==std_list<EntityPtr>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "std_list<EntityPtr> FindEntitiesContaining(const QString &in) const", AS_METHOD_FUNCTION_PR(Scene, FindEntitiesContaining, (const QString &) const, EntityList), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QList< Entity * >(==QList< Entity * >) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "QList< Entity * > LoadSceneXML(const QString &in,bool,bool,AttributeChange_Type)", AS_METHOD_FUNCTION_PR(Scene, LoadSceneXML, (const QString &,bool,bool,AttributeChange::Type), QList< Entity * >), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QByteArray(==QByteArray) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "QByteArray GetSceneXML(bool,bool) const", AS_METHOD_FUNCTION_PR(Scene, GetSceneXML, (bool,bool) const, QByteArray), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const QString & (==const QString &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "bool SaveSceneXML(const QString &in,bool,bool)", AS_METHOD_FUNCTION_PR(Scene, SaveSceneXML, (const QString &,bool,bool), bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QList< Entity * >(==QList< Entity * >) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "QList< Entity * > LoadSceneBinary(const QString &in,bool,bool,AttributeChange_Type)", AS_METHOD_FUNCTION_PR(Scene, LoadSceneBinary, (const QString &,bool,bool,AttributeChange::Type), QList< Entity * >), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const QString & (==const QString &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "bool SaveSceneBinary(const QString &in,bool,bool)", AS_METHOD_FUNCTION_PR(Scene, SaveSceneBinary, (const QString &,bool,bool), bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QList< Entity * >(==QList< Entity * >) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "QList< Entity * > CreateContentFromXml(const QString &in,bool,AttributeChange_Type)", AS_METHOD_FUNCTION_PR(Scene, CreateContentFromXml, (const QString &,bool,AttributeChange::Type), QList< Entity * >), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QList< Entity * >(==QList< Entity * >) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "QList< Entity * > CreateContentFromXml(const QDomDocument &in,bool,AttributeChange_Type)", AS_METHOD_FUNCTION_PR(Scene, CreateContentFromXml, (const QDomDocument &,bool,AttributeChange::Type), QList< Entity * >), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QList< Entity * >(==QList< Entity * >) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "QList< Entity * > CreateContentFromBinary(const QString &in,bool,AttributeChange_Type)", AS_METHOD_FUNCTION_PR(Scene, CreateContentFromBinary, (const QString &,bool,AttributeChange::Type), QList< Entity * >), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QList< Entity * >(==QList< Entity * >) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "QList< Entity * > CreateContentFromBinary(const int8 *,int,bool,AttributeChange_Type)", AS_METHOD_FUNCTION_PR(Scene, CreateContentFromBinary, (const char *,int,bool,AttributeChange::Type), QList< Entity * >), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(UserConnection * (==UserConnection @) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "bool AllowModifyEntity(UserConnection @,Entity @)", AS_METHOD_FUNCTION_PR(Scene, AllowModifyEntity, (UserConnection *,Entity *), bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Scene", "void EmitEntityCreated(Entity @,AttributeChange_Type)", AS_METHOD_FUNCTION_PR(Scene, EmitEntityCreated, (Entity *,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Scene", "EntityPtr GetEntity(uint) const", AS_METHOD_FUNCTION_PR(Scene, GetEntity, (entity_id_t) const, EntityPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const QString & (==const QString &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "EntityPtr GetEntityByName(const QString &in) const", AS_METHOD_FUNCTION_PR(Scene, GetEntityByName, (const QString &) const, EntityPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(EntityList(==std_list<EntityPtr>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "std_list<EntityPtr> GetEntitiesWithComponent(const QString &in,const QString &in) const", AS_METHOD_FUNCTION_PR(Scene, GetEntitiesWithComponent, (const QString &,const QString &) const, EntityList), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(EntityList(==std_list<EntityPtr>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "std_list<EntityPtr> GetAllEntities() const", AS_METHOD_FUNCTION_PR(Scene, GetAllEntities, () const, EntityList), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QVariantList(==QVariantList) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "QVariantList GetEntityIdsWithComponent(const QString &in) const", AS_METHOD_FUNCTION_PR(Scene, GetEntityIdsWithComponent, (const QString &) const, QVariantList), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Scene", "Entity @ GetEntityRaw(uint) const", AS_METHOD_FUNCTION_PR(Scene, GetEntityRaw, (uint) const, Entity *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Scene", "bool DeleteEntityById(uint,AttributeChange_Type)", AS_METHOD_FUNCTION_PR(Scene, DeleteEntityById, (uint,AttributeChange::Type), bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Scene", "bool RemoveEntityRaw(int,AttributeChange_Type)", AS_METHOD_FUNCTION_PR(Scene, RemoveEntityRaw, (int,AttributeChange::Type), bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(EntityMap(==std_map<entity_id_t, EntityPtr>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "std_map<entity_id_t, EntityPtr> Entities()", AS_METHOD_FUNCTION_PR(Scene, Entities, (), EntityMap), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QByteArray(==QByteArray) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "QByteArray GetEntityXml(Entity @) const", AS_METHOD_FUNCTION_PR(Scene, GetEntityXml, (Entity *) const, QByteArray), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);



	// /*(boost::shared_ptr< T >(==boost_shared_ptr< T >) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "boost_shared_ptr< T > GetComponent() const", AS_METHOD_FUNCTION_PR(Entity, GetComponent, () const, boost::shared_ptr< T >), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(std::vector< boost::shared_ptr< T > >(==std_vector< boost_shared_ptr< T > >) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "std_vector< boost_shared_ptr< T > > GetComponents() const", AS_METHOD_FUNCTION_PR(Entity, GetComponents, () const, std::vector< boost::shared_ptr< T > >), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(boost::shared_ptr< T >(==boost_shared_ptr< T >) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "boost_shared_ptr< T > GetComponent(const QString &in) const", AS_METHOD_FUNCTION_PR(Entity, GetComponent, (const QString &) const, boost::shared_ptr< T >), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(Attribute < T > *(==Attribute < T > *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "Attribute < T > * GetAttribute(const QString &in) const", AS_METHOD_FUNCTION_PR(Entity, GetAttribute, (const QString &) const, Attribute < T > *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(std::vector< Attribute < T > >(==std_vector< Attribute < T > >) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "std_vector< Attribute < T > > GetAttributes(const QString &in) const", AS_METHOD_FUNCTION_PR(Entity, GetAttributes, (const QString &) const, std::vector< Attribute < T > >), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(inout refs are not supported for value types)*/ 	r = engine->RegisterObjectMethod("Entity", "void SerializeToBinary(kNet_DataSerializer &) const", AS_METHOD_FUNCTION_PR(Entity, SerializeToBinary, (kNet::DataSerializer &) const, void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Entity", "void EmitEnterView(IComponent @)", AS_METHOD_FUNCTION_PR(Entity, EmitEnterView, (IComponent *), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Entity", "void EmitLeaveView(IComponent @)", AS_METHOD_FUNCTION_PR(Entity, EmitLeaveView, (IComponent *), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(operators <, <=, > and >= are implemented by exposing operator opCmp)*/ 	r = engine->RegisterObjectMethod("Entity", "bool operator<(const Entity &in) const", AS_METHOD_FUNCTION_PR(Entity, operator<, (const Entity &) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Entity", "void ChangeComponentId(uint,uint)", AS_METHOD_FUNCTION_PR(Entity, ChangeComponentId, (component_id_t,component_id_t), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ComponentPtr(==boost_shared_ptr<IComponent>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "boost_shared_ptr<IComponent> CreateComponentWithId(uint,boost_uint32_t,const QString &in,AttributeChange_Type)", AS_METHOD_FUNCTION_PR(Entity, CreateComponentWithId, (component_id_t,u32,const QString &,AttributeChange::Type), ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const ComponentMap &(==const ComponentMap &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "const ComponentMap & Components() const", AS_METHOD_FUNCTION_PR(Entity, Components, () const, const ComponentMap &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const QString & (==const QString &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "IAttribute @ GetAttribute(const QString &in) const", AS_METHOD_FUNCTION_PR(Entity, GetAttribute, (const QString &) const, IAttribute *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(AttributeVector(==std_vector<IAttribute*>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "std_vector<IAttribute*> GetAttributes(const QString &in) const", AS_METHOD_FUNCTION_PR(Entity, GetAttributes, (const QString &) const, AttributeVector), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const ActionMap &(==const ActionMap &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "const ActionMap & Actions() const", AS_METHOD_FUNCTION_PR(Entity, Actions, () const, const ActionMap &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ComponentPtr(==boost_shared_ptr<IComponent>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "boost_shared_ptr<IComponent> GetComponentById(uint) const", AS_METHOD_FUNCTION_PR(Entity, GetComponentById, (component_id_t) const, ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ComponentPtr(==boost_shared_ptr<IComponent>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "boost_shared_ptr<IComponent> GetComponent(const QString &in) const", AS_METHOD_FUNCTION_PR(Entity, GetComponent, (const QString &) const, ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ComponentPtr(==boost_shared_ptr<IComponent>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "boost_shared_ptr<IComponent> GetComponent(boost_uint32_t) const", AS_METHOD_FUNCTION_PR(Entity, GetComponent, (u32) const, ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ComponentPtr(==boost_shared_ptr<IComponent>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "boost_shared_ptr<IComponent> GetComponent(const QString &in,const QString &in) const", AS_METHOD_FUNCTION_PR(Entity, GetComponent, (const QString &,const QString &) const, ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ComponentPtr(==boost_shared_ptr<IComponent>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "boost_shared_ptr<IComponent> GetComponent(boost_uint32_t,const QString &in) const", AS_METHOD_FUNCTION_PR(Entity, GetComponent, (u32,const QString &) const, ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ComponentPtr(==boost_shared_ptr<IComponent>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "boost_shared_ptr<IComponent> GetOrCreateComponent(const QString &in,AttributeChange_Type,bool)", AS_METHOD_FUNCTION_PR(Entity, GetOrCreateComponent, (const QString &,AttributeChange::Type,bool), ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ComponentPtr(==boost_shared_ptr<IComponent>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "boost_shared_ptr<IComponent> GetOrCreateComponent(const QString &in,const QString &in,AttributeChange_Type,bool)", AS_METHOD_FUNCTION_PR(Entity, GetOrCreateComponent, (const QString &,const QString &,AttributeChange::Type,bool), ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ComponentPtr(==boost_shared_ptr<IComponent>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "boost_shared_ptr<IComponent> GetOrCreateComponent(boost_uint32_t,AttributeChange_Type,bool)", AS_METHOD_FUNCTION_PR(Entity, GetOrCreateComponent, (u32,AttributeChange::Type,bool), ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ComponentPtr(==boost_shared_ptr<IComponent>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "boost_shared_ptr<IComponent> GetOrCreateComponent(boost_uint32_t,const QString &in,AttributeChange_Type,bool)", AS_METHOD_FUNCTION_PR(Entity, GetOrCreateComponent, (u32,const QString &,AttributeChange::Type,bool), ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ComponentPtr(==boost_shared_ptr<IComponent>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "boost_shared_ptr<IComponent> GetOrCreateLocalComponent(const QString &in)", AS_METHOD_FUNCTION_PR(Entity, GetOrCreateLocalComponent, (const QString &), ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ComponentPtr(==boost_shared_ptr<IComponent>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "boost_shared_ptr<IComponent> GetOrCreateLocalComponent(const QString &in,const QString &in)", AS_METHOD_FUNCTION_PR(Entity, GetOrCreateLocalComponent, (const QString &,const QString &), ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ComponentPtr(==boost_shared_ptr<IComponent>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "boost_shared_ptr<IComponent> CreateComponent(const QString &in,AttributeChange_Type,bool)", AS_METHOD_FUNCTION_PR(Entity, CreateComponent, (const QString &,AttributeChange::Type,bool), ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ComponentPtr(==boost_shared_ptr<IComponent>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "boost_shared_ptr<IComponent> CreateComponent(const QString &in,const QString &in,AttributeChange_Type,bool)", AS_METHOD_FUNCTION_PR(Entity, CreateComponent, (const QString &,const QString &,AttributeChange::Type,bool), ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ComponentPtr(==boost_shared_ptr<IComponent>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "boost_shared_ptr<IComponent> CreateComponent(boost_uint32_t,AttributeChange_Type,bool)", AS_METHOD_FUNCTION_PR(Entity, CreateComponent, (u32,AttributeChange::Type,bool), ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ComponentPtr(==boost_shared_ptr<IComponent>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "boost_shared_ptr<IComponent> CreateComponent(boost_uint32_t,const QString &in,AttributeChange_Type,bool)", AS_METHOD_FUNCTION_PR(Entity, CreateComponent, (u32,const QString &,AttributeChange::Type,bool), ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ComponentPtr(==boost_shared_ptr<IComponent>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "boost_shared_ptr<IComponent> CreateLocalComponent(const QString &in)", AS_METHOD_FUNCTION_PR(Entity, CreateLocalComponent, (const QString &), ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ComponentPtr(==boost_shared_ptr<IComponent>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "boost_shared_ptr<IComponent> CreateLocalComponent(const QString &in,const QString &in)", AS_METHOD_FUNCTION_PR(Entity, CreateLocalComponent, (const QString &,const QString &), ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const ComponentPtr & (==const ComponentPtr &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "void AddComponent(const ComponentPtr &in,AttributeChange_Type)", AS_METHOD_FUNCTION_PR(Entity, AddComponent, (const ComponentPtr &,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const ComponentPtr & (==const ComponentPtr &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "void AddComponent(uint,const ComponentPtr &in,AttributeChange_Type)", AS_METHOD_FUNCTION_PR(Entity, AddComponent, (component_id_t,const ComponentPtr &,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const ComponentPtr & (==const ComponentPtr &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "void RemoveComponent(const ComponentPtr &in,AttributeChange_Type)", AS_METHOD_FUNCTION_PR(Entity, RemoveComponent, (const ComponentPtr &,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const QString & (==const QString &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "void RemoveComponent(const QString &in,AttributeChange_Type)", AS_METHOD_FUNCTION_PR(Entity, RemoveComponent, (const QString &,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const QString & (==const QString &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "void RemoveComponent(const QString &in,const QString &in,AttributeChange_Type)", AS_METHOD_FUNCTION_PR(Entity, RemoveComponent, (const QString &,const QString &,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Entity", "void RemoveComponentById(uint,AttributeChange_Type)", AS_METHOD_FUNCTION_PR(Entity, RemoveComponentById, (component_id_t,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ComponentVector(==std_vector<ComponentPtr>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "std_vector<ComponentPtr> GetComponents(const QString &in) const", AS_METHOD_FUNCTION_PR(Entity, GetComponents, (const QString &) const, ComponentVector), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Entity", "EntityPtr Clone(bool,bool) const", AS_METHOD_FUNCTION_PR(Entity, Clone, (bool,bool) const, EntityPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(inout refs are not supported for value types)*/ 	r = engine->RegisterObjectMethod("Entity", "void SerializeToXML(QDomDocument &,QDomElement &,bool) const", AS_METHOD_FUNCTION_PR(Entity, SerializeToXML, (QDomDocument &,QDomElement &,bool) const, void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QString(==QString) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "QString SerializeToXMLString(bool) const", AS_METHOD_FUNCTION_PR(Entity, SerializeToXMLString, (bool) const, QString), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const QString & (==const QString &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "void SetName(const QString &in)", AS_METHOD_FUNCTION_PR(Entity, SetName, (const QString &), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QString(==QString) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "QString Name() const", AS_METHOD_FUNCTION_PR(Entity, Name, () const, QString), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const QString & (==const QString &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "void SetDescription(const QString &in)", AS_METHOD_FUNCTION_PR(Entity, SetDescription, (const QString &), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QString(==QString) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "QString Description() const", AS_METHOD_FUNCTION_PR(Entity, Description, () const, QString), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(EntityAction *(==EntityAction @) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "EntityAction @ Action(const QString &in)", AS_METHOD_FUNCTION_PR(Entity, Action, (const QString &), EntityAction *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const QString & (==const QString &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "void RemoveAction(const QString &in)", AS_METHOD_FUNCTION_PR(Entity, RemoveAction, (const QString &), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const QString & (==const QString &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "void ConnectAction(const QString &in,const QObject *,const int8 *)", AS_METHOD_FUNCTION_PR(Entity, ConnectAction, (const QString &,const QObject *,const char *), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(EntityAction::ExecTypeField (==EntityAction_ExecTypeField) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "void Exec(EntityAction_ExecTypeField,const QString &in,const QString &in,const QString &in,const QString &in)", AS_METHOD_FUNCTION_PR(Entity, Exec, (EntityAction::ExecTypeField,const QString &,const QString &,const QString &,const QString &), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(EntityAction::ExecTypeField (==EntityAction_ExecTypeField) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "void Exec(EntityAction_ExecTypeField,const QString &in,const QStringList &in)", AS_METHOD_FUNCTION_PR(Entity, Exec, (EntityAction::ExecTypeField,const QString &,const QStringList &), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(EntityAction::ExecTypeField (==EntityAction_ExecTypeField) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "void Exec(EntityAction_ExecTypeField,const QString &in,const QVariantList &in)", AS_METHOD_FUNCTION_PR(Entity, Exec, (EntityAction::ExecTypeField,const QString &,const QVariantList &), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Entity", "void SetTemporary(bool)", AS_METHOD_FUNCTION_PR(Entity, SetTemporary, (bool), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Entity", "bool IsTemporary() const", AS_METHOD_FUNCTION_PR(Entity, IsTemporary, () const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Entity", "bool IsLocal() const", AS_METHOD_FUNCTION_PR(Entity, IsLocal, () const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Entity", "bool IsReplicated() const", AS_METHOD_FUNCTION_PR(Entity, IsReplicated, () const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Entity", "bool IsUnacked() const", AS_METHOD_FUNCTION_PR(Entity, IsUnacked, () const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QString(==QString) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "QString ToString() const", AS_METHOD_FUNCTION_PR(Entity, ToString, () const, QString), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QString(==QString) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "QString toString() const", AS_METHOD_FUNCTION_PR(Entity, toString, () const, QString), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Entity", "uint Id() const", AS_METHOD_FUNCTION_PR(Entity, Id, () const, entity_id_t), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Entity", "Framework @ GetFramework() const", AS_METHOD_FUNCTION_PR(Entity, GetFramework, () const, Framework *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Entity", "Scene @ ParentScene() const", AS_METHOD_FUNCTION_PR(Entity, ParentScene, () const, Scene *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QObjectList(==QObjectList) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "QObjectList ComponentsList() const", AS_METHOD_FUNCTION_PR(Entity, ComponentsList, () const, QObjectList), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QObjectList(==QObjectList) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "QObjectList GetComponentsRaw(const QString &in) const", AS_METHOD_FUNCTION_PR(Entity, GetComponentsRaw, (const QString &) const, QObjectList), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QObject * (==QObject *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "void RemoveComponentRaw(QObject *)", AS_METHOD_FUNCTION_PR(Entity, RemoveComponentRaw, (QObject *), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ComponentMap(==std_map<component_id_t, ComponentPtr>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "std_map<component_id_t, ComponentPtr> Components()", AS_METHOD_FUNCTION_PR(Entity, Components, (), ComponentMap), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);



		// /*(const QString &(==const QString &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("IComponent", "const QString & TypeName() const", AS_METHOD_FUNCTION_PR(IComponent, TypeName, () const, const QString &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(u32(==boost_uint32_t) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("IComponent", "boost_uint32_t TypeId() const", AS_METHOD_FUNCTION_PR(IComponent, TypeId, () const, u32), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const QString &(==const QString &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("IComponent", "const QString & Name() const", AS_METHOD_FUNCTION_PR(IComponent, Name, () const, const QString &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const QString & (==const QString &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("IComponent", "void SetName(const QString &in)", AS_METHOD_FUNCTION_PR(IComponent, SetName, (const QString &), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("IComponent", "void SetParentEntity(Entity @)", AS_METHOD_FUNCTION_PR(IComponent, SetParentEntity, (Entity *), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const AttributeVector &(==const AttributeVector &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("IComponent", "const AttributeVector & Attributes() const", AS_METHOD_FUNCTION_PR(IComponent, Attributes, () const, const AttributeVector &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(AttributeVector(==std_vector<IAttribute*>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("IComponent", "std_vector<IAttribute*> NonEmptyAttributes() const", AS_METHOD_FUNCTION_PR(IComponent, NonEmptyAttributes, () const, AttributeVector), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(Attribute < T > *(==Attribute < T > *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("IComponent", "Attribute < T > * GetAttribute(const QString &in) const", AS_METHOD_FUNCTION_PR(IComponent, GetAttribute, (const QString &) const, Attribute < T > *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(inout refs are not supported for value types)*/ 	r = engine->RegisterObjectMethod("IComponent", "void DeserializeFrom(QDomElement &,AttributeChange_Type)", AS_METHOD_FUNCTION_PR(IComponent, DeserializeFrom, (QDomElement &,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(inout refs are not supported for value types)*/ 	r = engine->RegisterObjectMethod("IComponent", "void SerializeToBinary(kNet_DataSerializer &) const", AS_METHOD_FUNCTION_PR(IComponent, SerializeToBinary, (kNet::DataSerializer &) const, void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(inout refs are not supported for value types)*/ 	r = engine->RegisterObjectMethod("IComponent", "void DeserializeFromBinary(kNet_DataDeserializer &,AttributeChange_Type)", AS_METHOD_FUNCTION_PR(IComponent, DeserializeFromBinary, (kNet::DataDeserializer &,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const QString & (==const QString &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("IComponent", "IAttribute @ GetAttribute(const QString &in) const", AS_METHOD_FUNCTION_PR(IComponent, GetAttribute, (const QString &) const, IAttribute *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(u32 (==boost_uint32_t) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("IComponent", "IAttribute @ CreateAttribute(uint8,boost_uint32_t,const QString &in,AttributeChange_Type)", AS_METHOD_FUNCTION_PR(IComponent, CreateAttribute, (u8,u32,const QString &,AttributeChange::Type), IAttribute *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("IComponent", "void RemoveAttribute(uint8,AttributeChange_Type)", AS_METHOD_FUNCTION_PR(IComponent, RemoveAttribute, (u8,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	...
	r = engine->RegisterObjectMethod("IComponent", "Framework @ GetFramework() const", AS_METHOD_FUNCTION_PR(IComponent, GetFramework, () const, Framework *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("IComponent", "bool IsReplicated() const", AS_METHOD_FUNCTION_PR(IComponent, IsReplicated, () const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("IComponent", "bool IsLocal() const", AS_METHOD_FUNCTION_PR(IComponent, IsLocal, () const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("IComponent", "bool IsUnacked() const", AS_METHOD_FUNCTION_PR(IComponent, IsUnacked, () const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("IComponent", "void SetUpdateMode(AttributeChange_Type)", AS_METHOD_FUNCTION_PR(IComponent, SetUpdateMode, (AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("IComponent", "AttributeChange_Type UpdateMode() const", AS_METHOD_FUNCTION_PR(IComponent, UpdateMode, () const, AttributeChange::Type), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("IComponent", "uint Id() const", AS_METHOD_FUNCTION_PR(IComponent, Id, () const, component_id_t), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("IComponent", "int NumAttributes() const", AS_METHOD_FUNCTION_PR(IComponent, NumAttributes, () const, int), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("IComponent", "int NumStaticAttributes() const", AS_METHOD_FUNCTION_PR(IComponent, NumStaticAttributes, () const, int), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("IComponent", "void EmitAttributeChanged(IAttribute @,AttributeChange_Type)", AS_METHOD_FUNCTION_PR(IComponent, EmitAttributeChanged, (IAttribute *,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const QString & (==const QString &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("IComponent", "void EmitAttributeChanged(const QString &in,AttributeChange_Type)", AS_METHOD_FUNCTION_PR(IComponent, EmitAttributeChanged, (const QString &,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("IComponent", "void ComponentChanged(AttributeChange_Type)", AS_METHOD_FUNCTION_PR(IComponent, ComponentChanged, (AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("IComponent", "Entity @ ParentEntity() const", AS_METHOD_FUNCTION_PR(IComponent, ParentEntity, () const, Entity *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("IComponent", "Scene @ ParentScene() const", AS_METHOD_FUNCTION_PR(IComponent, ParentScene, () const, Scene *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("IComponent", "void SetTemporary(bool)", AS_METHOD_FUNCTION_PR(IComponent, SetTemporary, (bool), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("IComponent", "bool IsTemporary() const", AS_METHOD_FUNCTION_PR(IComponent, IsTemporary, () const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("IComponent", "bool ViewEnabled() const", AS_METHOD_FUNCTION_PR(IComponent, ViewEnabled, () const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QVariant(==QVariant) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("IComponent", "QVariant GetAttributeQVariant(const QString &in) const", AS_METHOD_FUNCTION_PR(IComponent, GetAttributeQVariant, (const QString &) const, QVariant), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QStringList(==QStringList) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("IComponent", "QStringList GetAttributeNames() const", AS_METHOD_FUNCTION_PR(IComponent, GetAttributeNames, () const, QStringList), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("IComponent", "void SetNetworkSyncEnabled(bool)", AS_METHOD_FUNCTION_PR(IComponent, SetNetworkSyncEnabled, (bool), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);



// /*(const char * (==const int8 *) is not known to angelscript)*/ 			r = engine->RegisterObjectMethod("IAttribute", "IComponent @ Owner() const", AS_METHOD_FUNCTION_PR(IAttribute, Owner, () const, IComponent *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const QString &(==const QString &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("IAttribute", "const QString & Name() const", AS_METHOD_FUNCTION_PR(IAttribute, Name, () const, const QString &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	...
	r = engine->RegisterObjectMethod("IAttribute", "void FromString(const string &in,AttributeChange_Type)", AS_METHOD_FUNCTION_PR(IAttribute, FromString, (const std::string &,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const QString &(==const QString &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("IAttribute", "const QString & TypeName() const", AS_METHOD_FUNCTION_PR(IAttribute, TypeName, () const, const QString &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(u32(==boost_uint32_t) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("IAttribute", "boost_uint32_t TypeId() const", AS_METHOD_FUNCTION_PR(IAttribute, TypeId, () const, u32), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(inout refs are not supported for value types)*/ 	r = engine->RegisterObjectMethod("IAttribute", "void ToBinary(kNet_DataSerializer &) const", AS_METHOD_FUNCTION_PR(IAttribute, ToBinary, (kNet::DataSerializer &) const, void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(inout refs are not supported for value types)*/ 	r = engine->RegisterObjectMethod("IAttribute", "void FromBinary(kNet_DataDeserializer &,AttributeChange_Type)", AS_METHOD_FUNCTION_PR(IAttribute, FromBinary, (kNet::DataDeserializer &,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QVariant(==QVariant) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("IAttribute", "QVariant ToQVariant() const", AS_METHOD_FUNCTION_PR(IAttribute, ToQVariant, () const, QVariant), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const QVariant & (==const QVariant &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("IAttribute", "void FromQVariant(const QVariant &in,AttributeChange_Type)", AS_METHOD_FUNCTION_PR(IAttribute, FromQVariant, (const QVariant &,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const QScriptValue & (==const QScriptValue &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("IAttribute", "void FromScriptValue(const QScriptValue &in,AttributeChange_Type)", AS_METHOD_FUNCTION_PR(IAttribute, FromScriptValue, (const QScriptValue &,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(AttributeMetadata * (==AttributeMetadata @) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("IAttribute", "void SetMetadata(AttributeMetadata @)", AS_METHOD_FUNCTION_PR(IAttribute, SetMetadata, (AttributeMetadata *), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(AttributeMetadata *(==AttributeMetadata @) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("IAttribute", "AttributeMetadata @ Metadata() const", AS_METHOD_FUNCTION_PR(IAttribute, Metadata, () const, AttributeMetadata *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	...
	r = engine->RegisterObjectMethod("IAttribute", "uint8 Index() const", AS_METHOD_FUNCTION_PR(IAttribute, Index, () const, u8), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("IAttribute", "void Changed(AttributeChange_Type)", AS_METHOD_FUNCTION_PR(IAttribute, Changed, (AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("IAttribute", "IAttribute @ Clone() const", AS_METHOD_FUNCTION_PR(IAttribute, Clone, () const, IAttribute *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("IAttribute", "void CopyValue(IAttribute @,AttributeChange_Type)", AS_METHOD_FUNCTION_PR(IAttribute, CopyValue, (IAttribute *,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("IAttribute", "void Interpolate(IAttribute @,IAttribute @,float,AttributeChange_Type)", AS_METHOD_FUNCTION_PR(IAttribute, Interpolate, (IAttribute *,IAttribute *,float,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(const float * (==const float *) is not known to angelscript)*/ 	r = engine->RegisterObjectBehaviour("float2", asBEHAVE_CONSTRUCT, "void f(const float *)", AS_CONSTRUCTOR(float2_ctor_const_float_ptr, float2, (const float *)), AS_CTOR_CONVENTION); assert(r >= 0);
// /*(float *(==float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float2", "float * ptr()", AS_METHOD_FUNCTION_PR(float2, ptr, (), float *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const float *(==const float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float2", "const float * ptr() const", AS_METHOD_FUNCTION_PR(float2, ptr, () const, const float *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(operator [] is not supported)*/ 	r = engine->RegisterObjectMethod("float2", "float & operator[](int)", AS_METHOD_FUNCTION_PR(float2, operator[], (int), float &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(CONST_WIN32 float(==CONST_WIN32 float) is not known to angelscript)(operator [] is not supported)*/ 	r = engine->RegisterObjectMethod("float2", "CONST_WIN32 float operator[](int) const", AS_METHOD_FUNCTION_PR(float2, operator[], (int) const, CONST_WIN32 float), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("float2", "float & At(int)", AS_METHOD_FUNCTION_PR(float2, At, (int), float &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(CONST_WIN32 float(==CONST_WIN32 float) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float2", "CONST_WIN32 float At(int) const", AS_METHOD_FUNCTION_PR(float2, At, (int) const, CONST_WIN32 float), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	...
	r = engine->RegisterObjectMethod("float2", "float2 & opAddAssign(const float2 &in)", AS_METHOD_FUNCTION_PR(float2, operator+=, (const float2 &), float2 &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("float2", "float2 & opSubAssign(const float2 &in)", AS_METHOD_FUNCTION_PR(float2, operator-=, (const float2 &), float2 &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("float2", "float2 & opMulAssign(float)", AS_METHOD_FUNCTION_PR(float2, operator*=, (float), float2 &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("float2", "float2 & opDivAssign(float)", AS_METHOD_FUNCTION_PR(float2, operator/=, (float), float2 &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	...
	//.classmethod(// /*(const char * (==const int8 *) is not known to angelscript)*/ 	//.classmethod(	//.classmethod(	//.classmethod(// /*(inout refs are not supported for value types)*/ 	//.classmethod(	//.classmethod(// /*(inout refs are not supported for value types)*/ 	//.classmethod(	//.classmethod(// /*(inout refs are not supported for value types)*/ 	//.classmethod(// /*(float2 * (==float2 *) is not known to angelscript)*/ 	//.classmethod(// /*(inout refs are not supported for value types)*/ 	//.classmethod(// /*(inout refs are not supported for value types)*/ 	//.classmethod(
...
// /*(const float * (==const float *) is not known to angelscript)*/ 	r = engine->RegisterObjectBehaviour("float3", asBEHAVE_CONSTRUCT, "void f(const float *)", AS_CONSTRUCTOR(float3_ctor_const_float_ptr, float3, (const float *)), AS_CTOR_CONVENTION); assert(r >= 0);
// /*(float *(==float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float3", "float * ptr()", AS_METHOD_FUNCTION_PR(float3, ptr, (), float *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const float *(==const float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float3", "const float * ptr() const", AS_METHOD_FUNCTION_PR(float3, ptr, () const, const float *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(operator [] is not supported)*/ 	r = engine->RegisterObjectMethod("float3", "float & operator[](int)", AS_METHOD_FUNCTION_PR(float3, operator[], (int), float &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(CONST_WIN32 float(==CONST_WIN32 float) is not known to angelscript)(operator [] is not supported)*/ 	r = engine->RegisterObjectMethod("float3", "CONST_WIN32 float operator[](int) const", AS_METHOD_FUNCTION_PR(float3, operator[], (int) const, CONST_WIN32 float), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("float3", "float & At(int)", AS_METHOD_FUNCTION_PR(float3, At, (int), float &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(CONST_WIN32 float(==CONST_WIN32 float) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float3", "CONST_WIN32 float At(int) const", AS_METHOD_FUNCTION_PR(float3, At, (int) const, CONST_WIN32 float), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	...
	r = engine->RegisterObjectMethod("float3", "float3 & opAddAssign(const float3 &in)", AS_METHOD_FUNCTION_PR(float3, operator+=, (const float3 &), float3 &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("float3", "float3 & opSubAssign(const float3 &in)", AS_METHOD_FUNCTION_PR(float3, operator-=, (const float3 &), float3 &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("float3", "float3 & opMulAssign(float)", AS_METHOD_FUNCTION_PR(float3, operator*=, (float), float3 &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("float3", "float3 & opDivAssign(float)", AS_METHOD_FUNCTION_PR(float3, operator/=, (float), float3 &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	...
	//.classmethod(	//.classmethod(	//.classmethod(// /*(const char * (==const int8 *) is not known to angelscript)*/ 	//.classmethod(	//.classmethod(	//.classmethod(	//.classmethod(// /*(inout refs are not supported for value types)*/ 	//.classmethod(// /*(inout refs are not supported for value types)*/ 	//.classmethod(	//.classmethod(	//.classmethod(// /*(inout refs are not supported for value types)*/ 	//.classmethod(// /*(inout refs are not supported for value types)*/ 	//.classmethod(	//.classmethod(	//.classmethod(// /*(inout refs are not supported for value types)*/ 	//.classmethod(// /*(inout refs are not supported for value types)*/ 	//.classmethod(// /*(inout refs are not supported for value types)*/ 	//.classmethod(// /*(inout refs are not supported for value types)*/ 	//.classmethod(
...
// /*(const float * (==const float *) is not known to angelscript)*/ 	r = engine->RegisterObjectBehaviour("float4", asBEHAVE_CONSTRUCT, "void f(const float *)", AS_CONSTRUCTOR(float4_ctor_const_float_ptr, float4, (const float *)), AS_CTOR_CONVENTION); assert(r >= 0);
// /*(float *(==float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float4", "float * ptr()", AS_METHOD_FUNCTION_PR(float4, ptr, (), float *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const float *(==const float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float4", "const float * ptr() const", AS_METHOD_FUNCTION_PR(float4, ptr, () const, const float *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(operator [] is not supported)*/ 	r = engine->RegisterObjectMethod("float4", "float & operator[](int)", AS_METHOD_FUNCTION_PR(float4, operator[], (int), float &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(CONST_WIN32 float(==CONST_WIN32 float) is not known to angelscript)(operator [] is not supported)*/ 	r = engine->RegisterObjectMethod("float4", "CONST_WIN32 float operator[](int) const", AS_METHOD_FUNCTION_PR(float4, operator[], (int) const, CONST_WIN32 float), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("float4", "float & At(int)", AS_METHOD_FUNCTION_PR(float4, At, (int), float &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(CONST_WIN32 float(==CONST_WIN32 float) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float4", "CONST_WIN32 float At(int) const", AS_METHOD_FUNCTION_PR(float4, At, (int) const, CONST_WIN32 float), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	...
	r = engine->RegisterObjectMethod("float4", "float4 & opAddAssign(const float4 &in)", AS_METHOD_FUNCTION_PR(float4, operator+=, (const float4 &), float4 &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("float4", "float4 & opSubAssign(const float4 &in)", AS_METHOD_FUNCTION_PR(float4, operator-=, (const float4 &), float4 &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("float4", "float4 & opMulAssign(float)", AS_METHOD_FUNCTION_PR(float4, operator*=, (float), float4 &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("float4", "float4 & opDivAssign(float)", AS_METHOD_FUNCTION_PR(float4, operator/=, (float), float4 &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	...
	//.classmethod(	//.classmethod(// /*(const char * (==const int8 *) is not known to angelscript)*/ 	//.classmethod(	//.classmethod(	//.classmethod(// /*(inout refs are not supported for value types)*/ 	//.classmethod(
...
// /*(MatrixProxy < Cols > &(==MatrixProxy < Cols > &) is not known to angelscript)(operator [] is not supported)*/ 	r = engine->RegisterObjectMethod("float3x3", "MatrixProxy < Cols > & operator[](int)", AS_METHOD_FUNCTION_PR(float3x3, operator[], (int), MatrixProxy < Cols > &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const MatrixProxy < Cols > &(==const MatrixProxy < Cols > &) is not known to angelscript)(operator [] is not supported)*/ 	r = engine->RegisterObjectMethod("float3x3", "const MatrixProxy < Cols > & operator[](int) const", AS_METHOD_FUNCTION_PR(float3x3, operator[], (int) const, const MatrixProxy < Cols > &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("float3x3", "float & At(int,int)", AS_METHOD_FUNCTION_PR(float3x3, At, (int,int), float &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(CONST_WIN32 float(==CONST_WIN32 float) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float3x3", "CONST_WIN32 float At(int,int) const", AS_METHOD_FUNCTION_PR(float3x3, At, (int,int) const, CONST_WIN32 float), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("float3x3", "float3 & Row(int)", AS_METHOD_FUNCTION_PR(float3x3, Row, (int), float3 &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("float3x3", "const float3 & Row(int) const", AS_METHOD_FUNCTION_PR(float3x3, Row, (int) const, const float3 &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("float3x3", "float3 & Row3(int)", AS_METHOD_FUNCTION_PR(float3x3, Row3, (int), float3 &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("float3x3", "const float3 & Row3(int) const", AS_METHOD_FUNCTION_PR(float3x3, Row3, (int) const, const float3 &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(CONST_WIN32 float3(==CONST_WIN32 float3) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float3x3", "CONST_WIN32 float3 Col(int) const", AS_METHOD_FUNCTION_PR(float3x3, Col, (int) const, CONST_WIN32 float3), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(CONST_WIN32 float3(==CONST_WIN32 float3) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float3x3", "CONST_WIN32 float3 Col3(int) const", AS_METHOD_FUNCTION_PR(float3x3, Col3, (int) const, CONST_WIN32 float3), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(CONST_WIN32 float3(==CONST_WIN32 float3) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float3x3", "CONST_WIN32 float3 Diagonal() const", AS_METHOD_FUNCTION_PR(float3x3, Diagonal, () const, CONST_WIN32 float3), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(float *(==float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float3x3", "float * ptr()", AS_METHOD_FUNCTION_PR(float3x3, ptr, (), float *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const float *(==const float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float3x3", "const float * ptr() const", AS_METHOD_FUNCTION_PR(float3x3, ptr, () const, const float *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(const float * (==const float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float3x3", "void SetRow(int,const float *)", AS_METHOD_FUNCTION_PR(float3x3, SetRow, (int,const float *), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(const float * (==const float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float3x3", "void SetCol(int,const float *)", AS_METHOD_FUNCTION_PR(float3x3, SetCol, (int,const float *), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(const float * (==const float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float3x3", "void Set(const float *)", AS_METHOD_FUNCTION_PR(float3x3, Set, (const float *), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	...
	r = engine->RegisterObjectMethod("float3x3", "float3x3 & opAssign(const Quat &in)", AS_METHOD_FUNCTION_PR(float3x3, operator=, (const Quat &), float3x3 &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("float3x3", "float3x3 & opAssign(const float3x3 &in)", AS_METHOD_FUNCTION_PR(float3x3, operator=, (const float3x3 &), float3x3 &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(float3 * (==float3 *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float3x3", "void BatchTransform(float3 *,int) const", AS_METHOD_FUNCTION_PR(float3x3, BatchTransform, (float3 *,int) const, void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(float3 * (==float3 *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float3x3", "void BatchTransform(float3 *,int,int) const", AS_METHOD_FUNCTION_PR(float3x3, BatchTransform, (float3 *,int,int) const, void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(float4 * (==float4 *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float3x3", "void BatchTransform(float4 *,int) const", AS_METHOD_FUNCTION_PR(float3x3, BatchTransform, (float4 *,int) const, void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(float4 * (==float4 *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float3x3", "void BatchTransform(float4 *,int,int) const", AS_METHOD_FUNCTION_PR(float3x3, BatchTransform, (float4 *,int,int) const, void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	...
	r = engine->RegisterObjectMethod("float3x3", "float3x3 & opMulAssign(float)", AS_METHOD_FUNCTION_PR(float3x3, operator*=, (float), float3x3 &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("float3x3", "float3x3 & opDivAssign(float)", AS_METHOD_FUNCTION_PR(float3x3, operator/=, (float), float3x3 &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("float3x3", "float3x3 & opAddAssign(const float3x3 &in)", AS_METHOD_FUNCTION_PR(float3x3, operator+=, (const float3x3 &), float3x3 &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("float3x3", "float3x3 & opSubAssign(const float3x3 &in)", AS_METHOD_FUNCTION_PR(float3x3, operator-=, (const float3x3 &), float3x3 &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(MatrixProxy < Cols > &(==MatrixProxy < Cols > &) is not known to angelscript)(operator [] is not supported)*/ 	r = engine->RegisterObjectMethod("float3x4", "MatrixProxy < Cols > & operator[](int)", AS_METHOD_FUNCTION_PR(float3x4, operator[], (int), MatrixProxy < Cols > &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const MatrixProxy < Cols > &(==const MatrixProxy < Cols > &) is not known to angelscript)(operator [] is not supported)*/ 	r = engine->RegisterObjectMethod("float3x4", "const MatrixProxy < Cols > & operator[](int) const", AS_METHOD_FUNCTION_PR(float3x4, operator[], (int) const, const MatrixProxy < Cols > &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("float3x4", "float & At(int,int)", AS_METHOD_FUNCTION_PR(float3x4, At, (int,int), float &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(CONST_WIN32 float(==CONST_WIN32 float) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float3x4", "CONST_WIN32 float At(int,int) const", AS_METHOD_FUNCTION_PR(float3x4, At, (int,int) const, CONST_WIN32 float), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("float3x4", "float4 & Row(int)", AS_METHOD_FUNCTION_PR(float3x4, Row, (int), float4 &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("float3x4", "const float4 & Row(int) const", AS_METHOD_FUNCTION_PR(float3x4, Row, (int) const, const float4 &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("float3x4", "float3 & Row3(int)", AS_METHOD_FUNCTION_PR(float3x4, Row3, (int), float3 &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("float3x4", "const float3 & Row3(int) const", AS_METHOD_FUNCTION_PR(float3x4, Row3, (int) const, const float3 &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(CONST_WIN32 float3(==CONST_WIN32 float3) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float3x4", "CONST_WIN32 float3 Col(int) const", AS_METHOD_FUNCTION_PR(float3x4, Col, (int) const, CONST_WIN32 float3), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(CONST_WIN32 float3(==CONST_WIN32 float3) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float3x4", "CONST_WIN32 float3 Col3(int) const", AS_METHOD_FUNCTION_PR(float3x4, Col3, (int) const, CONST_WIN32 float3), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(CONST_WIN32 float3(==CONST_WIN32 float3) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float3x4", "CONST_WIN32 float3 Diagonal() const", AS_METHOD_FUNCTION_PR(float3x4, Diagonal, () const, CONST_WIN32 float3), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(CONST_WIN32 float3x3(==CONST_WIN32 float3x3) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float3x4", "CONST_WIN32 float3x3 Float3x3Part() const", AS_METHOD_FUNCTION_PR(float3x4, Float3x3Part, () const, CONST_WIN32 float3x3), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(CONST_WIN32 float3(==CONST_WIN32 float3) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float3x4", "CONST_WIN32 float3 TranslatePart() const", AS_METHOD_FUNCTION_PR(float3x4, TranslatePart, () const, CONST_WIN32 float3), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(CONST_WIN32 float3x3(==CONST_WIN32 float3x3) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float3x4", "CONST_WIN32 float3x3 RotatePart() const", AS_METHOD_FUNCTION_PR(float3x4, RotatePart, () const, CONST_WIN32 float3x3), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(float *(==float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float3x4", "float * ptr()", AS_METHOD_FUNCTION_PR(float3x4, ptr, (), float *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const float *(==const float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float3x4", "const float * ptr() const", AS_METHOD_FUNCTION_PR(float3x4, ptr, () const, const float *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(const float * (==const float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float3x4", "void SetRow(int,const float *)", AS_METHOD_FUNCTION_PR(float3x4, SetRow, (int,const float *), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(const float * (==const float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float3x4", "void SetCol(int,const float *)", AS_METHOD_FUNCTION_PR(float3x4, SetCol, (int,const float *), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(const float * (==const float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float3x4", "void Set(const float *)", AS_METHOD_FUNCTION_PR(float3x4, Set, (const float *), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	...
	r = engine->RegisterObjectMethod("float3x4", "float3x4 & opAssign(const float3x3 &in)", AS_METHOD_FUNCTION_PR(float3x4, operator=, (const float3x3 &), float3x4 &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("float3x4", "float3x4 & opAssign(const Quat &in)", AS_METHOD_FUNCTION_PR(float3x4, operator=, (const Quat &), float3x4 &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("float3x4", "float3x4 & opAssign(const float3x4 &in)", AS_METHOD_FUNCTION_PR(float3x4, operator=, (const float3x4 &), float3x4 &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(float3 * (==float3 *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float3x4", "void BatchTransformPos(float3 *,int) const", AS_METHOD_FUNCTION_PR(float3x4, BatchTransformPos, (float3 *,int) const, void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(float3 * (==float3 *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float3x4", "void BatchTransformPos(float3 *,int,int) const", AS_METHOD_FUNCTION_PR(float3x4, BatchTransformPos, (float3 *,int,int) const, void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(float3 * (==float3 *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float3x4", "void BatchTransformDir(float3 *,int) const", AS_METHOD_FUNCTION_PR(float3x4, BatchTransformDir, (float3 *,int) const, void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(float3 * (==float3 *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float3x4", "void BatchTransformDir(float3 *,int,int) const", AS_METHOD_FUNCTION_PR(float3x4, BatchTransformDir, (float3 *,int,int) const, void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(float4 * (==float4 *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float3x4", "void BatchTransform(float4 *,int) const", AS_METHOD_FUNCTION_PR(float3x4, BatchTransform, (float4 *,int) const, void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(float4 * (==float4 *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float3x4", "void BatchTransform(float4 *,int,int) const", AS_METHOD_FUNCTION_PR(float3x4, BatchTransform, (float4 *,int,int) const, void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	...
	r = engine->RegisterObjectMethod("float3x4", "float3x4 & opMulAssign(float)", AS_METHOD_FUNCTION_PR(float3x4, operator*=, (float), float3x4 &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("float3x4", "float3x4 & opDivAssign(float)", AS_METHOD_FUNCTION_PR(float3x4, operator/=, (float), float3x4 &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("float3x4", "float3x4 & opAddAssign(const float3x4 &in)", AS_METHOD_FUNCTION_PR(float3x4, operator+=, (const float3x4 &), float3x4 &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("float3x4", "float3x4 & opSubAssign(const float3x4 &in)", AS_METHOD_FUNCTION_PR(float3x4, operator-=, (const float3x4 &), float3x4 &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(MatrixProxy < Cols > &(==MatrixProxy < Cols > &) is not known to angelscript)(operator [] is not supported)*/ 	r = engine->RegisterObjectMethod("float4x4", "MatrixProxy < Cols > & operator[](int)", AS_METHOD_FUNCTION_PR(float4x4, operator[], (int), MatrixProxy < Cols > &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const MatrixProxy < Cols > &(==const MatrixProxy < Cols > &) is not known to angelscript)(operator [] is not supported)*/ 	r = engine->RegisterObjectMethod("float4x4", "const MatrixProxy < Cols > & operator[](int) const", AS_METHOD_FUNCTION_PR(float4x4, operator[], (int) const, const MatrixProxy < Cols > &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("float4x4", "float & At(int,int)", AS_METHOD_FUNCTION_PR(float4x4, At, (int,int), float &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(CONST_WIN32 float(==CONST_WIN32 float) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float4x4", "CONST_WIN32 float At(int,int) const", AS_METHOD_FUNCTION_PR(float4x4, At, (int,int) const, CONST_WIN32 float), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("float4x4", "float4 & Row(int)", AS_METHOD_FUNCTION_PR(float4x4, Row, (int), float4 &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("float4x4", "const float4 & Row(int) const", AS_METHOD_FUNCTION_PR(float4x4, Row, (int) const, const float4 &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("float4x4", "float3 & Row3(int)", AS_METHOD_FUNCTION_PR(float4x4, Row3, (int), float3 &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("float4x4", "const float3 & Row3(int) const", AS_METHOD_FUNCTION_PR(float4x4, Row3, (int) const, const float3 &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(CONST_WIN32 float4(==CONST_WIN32 float4) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float4x4", "CONST_WIN32 float4 Col(int) const", AS_METHOD_FUNCTION_PR(float4x4, Col, (int) const, CONST_WIN32 float4), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(CONST_WIN32 float3(==CONST_WIN32 float3) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float4x4", "CONST_WIN32 float3 Col3(int) const", AS_METHOD_FUNCTION_PR(float4x4, Col3, (int) const, CONST_WIN32 float3), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(CONST_WIN32 float4(==CONST_WIN32 float4) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float4x4", "CONST_WIN32 float4 Diagonal() const", AS_METHOD_FUNCTION_PR(float4x4, Diagonal, () const, CONST_WIN32 float4), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(CONST_WIN32 float3(==CONST_WIN32 float3) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float4x4", "CONST_WIN32 float3 Diagonal3() const", AS_METHOD_FUNCTION_PR(float4x4, Diagonal3, () const, CONST_WIN32 float3), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(const float3x3(==const float3x3) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float4x4", "const float3x3 Float3x3Part() const", AS_METHOD_FUNCTION_PR(float4x4, Float3x3Part, () const, const float3x3), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("float4x4", "float3x4 & Float3x4Part()", AS_METHOD_FUNCTION_PR(float4x4, Float3x4Part, (), float3x4 &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("float4x4", "const float3x4 & Float3x4Part() const", AS_METHOD_FUNCTION_PR(float4x4, Float3x4Part, () const, const float3x4 &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(CONST_WIN32 float3(==CONST_WIN32 float3) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float4x4", "CONST_WIN32 float3 TranslatePart() const", AS_METHOD_FUNCTION_PR(float4x4, TranslatePart, () const, CONST_WIN32 float3), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(CONST_WIN32 float3x3(==CONST_WIN32 float3x3) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float4x4", "CONST_WIN32 float3x3 RotatePart() const", AS_METHOD_FUNCTION_PR(float4x4, RotatePart, () const, CONST_WIN32 float3x3), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(float *(==float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float4x4", "float * ptr()", AS_METHOD_FUNCTION_PR(float4x4, ptr, (), float *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const float *(==const float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float4x4", "const float * ptr() const", AS_METHOD_FUNCTION_PR(float4x4, ptr, () const, const float *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(const float * (==const float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float4x4", "void SetRow3(int,const float *)", AS_METHOD_FUNCTION_PR(float4x4, SetRow3, (int,const float *), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(const float * (==const float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float4x4", "void SetRow(int,const float *)", AS_METHOD_FUNCTION_PR(float4x4, SetRow, (int,const float *), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(const float * (==const float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float4x4", "void SetCol3(int,const float *)", AS_METHOD_FUNCTION_PR(float4x4, SetCol3, (int,const float *), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(const float * (==const float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float4x4", "void SetCol(int,const float *)", AS_METHOD_FUNCTION_PR(float4x4, SetCol, (int,const float *), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(const float * (==const float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float4x4", "void Set(const float *)", AS_METHOD_FUNCTION_PR(float4x4, Set, (const float *), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	...
	r = engine->RegisterObjectMethod("float4x4", "float4x4 & opAssign(const float3x3 &in)", AS_METHOD_FUNCTION_PR(float4x4, operator=, (const float3x3 &), float4x4 &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("float4x4", "float4x4 & opAssign(const float3x4 &in)", AS_METHOD_FUNCTION_PR(float4x4, operator=, (const float3x4 &), float4x4 &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("float4x4", "float4x4 & opAssign(const float4x4 &in)", AS_METHOD_FUNCTION_PR(float4x4, operator=, (const float4x4 &), float4x4 &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("float4x4", "float4x4 & opAssign(const Quat &in)", AS_METHOD_FUNCTION_PR(float4x4, operator=, (const Quat &), float4x4 &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(float3 * (==float3 *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float4x4", "void TransformPos(float3 *,int) const", AS_METHOD_FUNCTION_PR(float4x4, TransformPos, (float3 *,int) const, void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(float3 * (==float3 *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float4x4", "void TransformPos(float3 *,int,int) const", AS_METHOD_FUNCTION_PR(float4x4, TransformPos, (float3 *,int,int) const, void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(float3 * (==float3 *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float4x4", "void TransformDir(float3 *,int) const", AS_METHOD_FUNCTION_PR(float4x4, TransformDir, (float3 *,int) const, void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(float3 * (==float3 *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float4x4", "void TransformDir(float3 *,int,int) const", AS_METHOD_FUNCTION_PR(float4x4, TransformDir, (float3 *,int,int) const, void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(float4 * (==float4 *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float4x4", "void Transform(float4 *,int) const", AS_METHOD_FUNCTION_PR(float4x4, Transform, (float4 *,int) const, void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(float4 * (==float4 *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("float4x4", "void Transform(float4 *,int,int) const", AS_METHOD_FUNCTION_PR(float4x4, Transform, (float4 *,int,int) const, void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	...
	r = engine->RegisterObjectMethod("float4x4", "float4x4 & opMulAssign(float)", AS_METHOD_FUNCTION_PR(float4x4, operator*=, (float), float4x4 &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("float4x4", "float4x4 & opDivAssign(float)", AS_METHOD_FUNCTION_PR(float4x4, operator/=, (float), float4x4 &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("float4x4", "float4x4 & opAddAssign(const float4x4 &in)", AS_METHOD_FUNCTION_PR(float4x4, operator+=, (const float4x4 &), float4x4 &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("float4x4", "float4x4 & opSubAssign(const float4x4 &in)", AS_METHOD_FUNCTION_PR(float4x4, operator-=, (const float4x4 &), float4x4 &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(const float * (==const float *) is not known to angelscript)*/ 	r = engine->RegisterObjectBehaviour("Quat", asBEHAVE_CONSTRUCT, "void f(const float *)", AS_CONSTRUCTOR(Quat_ctor_const_float_ptr, Quat, (const float *)), AS_CTOR_CONVENTION); assert(r >= 0);
...
// /*(float *(==float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Quat", "float * ptr()", AS_METHOD_FUNCTION_PR(Quat, ptr, (), float *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const float *(==const float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Quat", "const float * ptr() const", AS_METHOD_FUNCTION_PR(Quat, ptr, () const, const float *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(const float3 * (==const float3 *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("AABB", "void SetFrom(const float3 *,int)", AS_METHOD_FUNCTION_PR(AABB, SetFrom, (const float3 *,int), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(Polyhedron(==Polyhedron) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("AABB", "Polyhedron ToPolyhedron() const", AS_METHOD_FUNCTION_PR(AABB, ToPolyhedron, () const, Polyhedron), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(float3 * (==float3 *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("AABB", "void GetCornerPoints(float3 *) const", AS_METHOD_FUNCTION_PR(AABB, GetCornerPoints, (float3 *) const, void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(Plane * (==Plane *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("AABB", "void GetFacePlanes(Plane *) const", AS_METHOD_FUNCTION_PR(AABB, GetFacePlanes, (Plane *) const, void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(const Polygon & (==const Polygon &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("AABB", "bool Contains(const Polygon &in) const", AS_METHOD_FUNCTION_PR(AABB, Contains, (const Polygon &) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(const Polyhedron & (==const Polyhedron &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("AABB", "bool Contains(const Polyhedron &in) const", AS_METHOD_FUNCTION_PR(AABB, Contains, (const Polyhedron &) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(float * (==float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("AABB", "bool Intersects(const Ray &in,float *,float *) const", AS_METHOD_FUNCTION_PR(AABB, Intersects, (const Ray &,float *,float *) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(float * (==float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("AABB", "bool Intersects(const Line &in,float *,float *) const", AS_METHOD_FUNCTION_PR(AABB, Intersects, (const Line &,float *,float *) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(float * (==float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("AABB", "bool Intersects(const LineSegment &in,float *,float *) const", AS_METHOD_FUNCTION_PR(AABB, Intersects, (const LineSegment &,float *,float *) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(float3 * (==float3 *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("AABB", "bool Intersects(const Sphere &in,float3 *) const", AS_METHOD_FUNCTION_PR(AABB, Intersects, (const Sphere &,float3 *) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(const Polygon & (==const Polygon &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("AABB", "bool Intersects(const Polygon &in) const", AS_METHOD_FUNCTION_PR(AABB, Intersects, (const Polygon &) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(const Polyhedron & (==const Polyhedron &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("AABB", "bool Intersects(const Polyhedron &in) const", AS_METHOD_FUNCTION_PR(AABB, Intersects, (const Polyhedron &) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(const Polygon & (==const Polygon &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("AABB", "void Enclose(const Polygon &in)", AS_METHOD_FUNCTION_PR(AABB, Enclose, (const Polygon &), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const Polyhedron & (==const Polyhedron &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("AABB", "void Enclose(const Polyhedron &in)", AS_METHOD_FUNCTION_PR(AABB, Enclose, (const Polyhedron &), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const float3 * (==const float3 *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("AABB", "void Enclose(const float3 *,int)", AS_METHOD_FUNCTION_PR(AABB, Enclose, (const float3 *,int), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(float3 * (==float3 *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("AABB", "void Triangulate(int,int,int,float3 *,float3 *,float2 *) const", AS_METHOD_FUNCTION_PR(AABB, Triangulate, (int,int,int,float3 *,float3 *,float2 *) const, void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(float3 * (==float3 *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("AABB", "void ToEdgeList(float3 *) const", AS_METHOD_FUNCTION_PR(AABB, ToEdgeList, (float3 *) const, void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(const float3 * (==const float3 *) is not known to angelscript)*/ 	//.classmethod(// /*(const float3 * (==const float3 *) is not known to angelscript)*/ 	//.classmethod(	//.classmethod(	//.classmethod(	//.classmethod(
...
// /*(const Polygon & (==const Polygon &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Capsule", "bool Contains(const Polygon &in) const", AS_METHOD_FUNCTION_PR(Capsule, Contains, (const Polygon &) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(const Polyhedron & (==const Polyhedron &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Capsule", "bool Contains(const Polyhedron &in) const", AS_METHOD_FUNCTION_PR(Capsule, Contains, (const Polyhedron &) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(const Polygon & (==const Polygon &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Capsule", "bool Intersects(const Polygon &in) const", AS_METHOD_FUNCTION_PR(Capsule, Intersects, (const Polygon &) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(const Polyhedron & (==const Polyhedron &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Capsule", "bool Intersects(const Polyhedron &in) const", AS_METHOD_FUNCTION_PR(Capsule, Intersects, (const Polyhedron &) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(float3 * (==float3 *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Circle", "int Intersects(const Plane &in,float3 *,float3 *) const", AS_METHOD_FUNCTION_PR(Circle, Intersects, (const Plane &,float3 *,float3 *) const, int), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(std::vector< float3 >(==std_vector< float3 >) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Circle", "std_vector< float3 > IntersectsFaces(const OBB &in) const", AS_METHOD_FUNCTION_PR(Circle, IntersectsFaces, (const OBB &) const, std::vector< float3 >), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(std::vector< float3 >(==std_vector< float3 >) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Circle", "std_vector< float3 > IntersectsFaces(const AABB &in) const", AS_METHOD_FUNCTION_PR(Circle, IntersectsFaces, (const AABB &) const, std::vector< float3 >), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(Plane * (==Plane *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Frustum", "void GetPlanes(Plane *) const", AS_METHOD_FUNCTION_PR(Frustum, GetPlanes, (Plane *) const, void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(float3 * (==float3 *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Frustum", "void GetCornerPoints(float3 *) const", AS_METHOD_FUNCTION_PR(Frustum, GetCornerPoints, (float3 *) const, void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(Polyhedron(==Polyhedron) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Frustum", "Polyhedron ToPolyhedron() const", AS_METHOD_FUNCTION_PR(Frustum, ToPolyhedron, () const, Polyhedron), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(const Polygon & (==const Polygon &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Frustum", "bool Contains(const Polygon &in) const", AS_METHOD_FUNCTION_PR(Frustum, Contains, (const Polygon &) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(const Polyhedron & (==const Polyhedron &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Frustum", "bool Contains(const Polyhedron &in) const", AS_METHOD_FUNCTION_PR(Frustum, Contains, (const Polyhedron &) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(const Polygon & (==const Polygon &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Frustum", "bool Intersects(const Polygon &in) const", AS_METHOD_FUNCTION_PR(Frustum, Intersects, (const Polygon &) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(const Polyhedron & (==const Polyhedron &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Frustum", "bool Intersects(const Polyhedron &in) const", AS_METHOD_FUNCTION_PR(Frustum, Intersects, (const Polyhedron &) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(float * (==float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Line", "float Distance(const float3 &in,float *) const", AS_METHOD_FUNCTION_PR(Line, Distance, (const float3 &,float *) const, float), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(float * (==float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Line", "float Distance(const Ray &in,float *,float *) const", AS_METHOD_FUNCTION_PR(Line, Distance, (const Ray &,float *,float *) const, float), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(float * (==float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Line", "float Distance(const Line &in,float *,float *) const", AS_METHOD_FUNCTION_PR(Line, Distance, (const Line &,float *,float *) const, float), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(float * (==float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Line", "float Distance(const LineSegment &in,float *,float *) const", AS_METHOD_FUNCTION_PR(Line, Distance, (const LineSegment &,float *,float *) const, float), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(float * (==float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Line", "float3 ClosestPoint(const float3 &in,float *) const", AS_METHOD_FUNCTION_PR(Line, ClosestPoint, (const float3 &,float *) const, float3), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(float * (==float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Line", "float3 ClosestPoint(const Ray &in,float *,float *) const", AS_METHOD_FUNCTION_PR(Line, ClosestPoint, (const Ray &,float *,float *) const, float3), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(float * (==float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Line", "float3 ClosestPoint(const Line &in,float *,float *) const", AS_METHOD_FUNCTION_PR(Line, ClosestPoint, (const Line &,float *,float *) const, float3), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(float * (==float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Line", "float3 ClosestPoint(const LineSegment &in,float *,float *) const", AS_METHOD_FUNCTION_PR(Line, ClosestPoint, (const LineSegment &,float *,float *) const, float3), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(float * (==float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Line", "float3 ClosestPoint(const Triangle &in,float *,float *,float *) const", AS_METHOD_FUNCTION_PR(Line, ClosestPoint, (const Triangle &,float *,float *,float *) const, float3), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(float * (==float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Line", "bool Intersects(const Triangle &in,float *,float3 *) const", AS_METHOD_FUNCTION_PR(Line, Intersects, (const Triangle &,float *,float3 *) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(float * (==float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Line", "bool Intersects(const Plane &in,float *) const", AS_METHOD_FUNCTION_PR(Line, Intersects, (const Plane &,float *) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(float3 * (==float3 *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Line", "bool Intersects(const Sphere &in,float3 *,float3 *,float *) const", AS_METHOD_FUNCTION_PR(Line, Intersects, (const Sphere &,float3 *,float3 *,float *) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(float * (==float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Line", "bool Intersects(const AABB &in,float *,float *) const", AS_METHOD_FUNCTION_PR(Line, Intersects, (const AABB &,float *,float *) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(float * (==float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Line", "bool Intersects(const OBB &in,float *,float *) const", AS_METHOD_FUNCTION_PR(Line, Intersects, (const OBB &,float *,float *) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(const Polygon & (==const Polygon &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Line", "bool Intersects(const Polygon &in) const", AS_METHOD_FUNCTION_PR(Line, Intersects, (const Polygon &) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(const Polyhedron & (==const Polyhedron &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Line", "bool Intersects(const Polyhedron &in) const", AS_METHOD_FUNCTION_PR(Line, Intersects, (const Polyhedron &) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	...
	//.classmethod(// /*(float * (==float *) is not known to angelscript)*/ 	//.classmethod(
...
// /*(float * (==float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("LineSegment", "float3 ClosestPoint(const float3 &in,float *) const", AS_METHOD_FUNCTION_PR(LineSegment, ClosestPoint, (const float3 &,float *) const, float3), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(float * (==float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("LineSegment", "float3 ClosestPoint(const Ray &in,float *,float *) const", AS_METHOD_FUNCTION_PR(LineSegment, ClosestPoint, (const Ray &,float *,float *) const, float3), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(float * (==float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("LineSegment", "float3 ClosestPoint(const Line &in,float *,float *) const", AS_METHOD_FUNCTION_PR(LineSegment, ClosestPoint, (const Line &,float *,float *) const, float3), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(float * (==float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("LineSegment", "float3 ClosestPoint(const LineSegment &in,float *,float *) const", AS_METHOD_FUNCTION_PR(LineSegment, ClosestPoint, (const LineSegment &,float *,float *) const, float3), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(float * (==float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("LineSegment", "float Distance(const float3 &in,float *) const", AS_METHOD_FUNCTION_PR(LineSegment, Distance, (const float3 &,float *) const, float), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(float * (==float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("LineSegment", "float Distance(const Ray &in,float *,float *) const", AS_METHOD_FUNCTION_PR(LineSegment, Distance, (const Ray &,float *,float *) const, float), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(float * (==float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("LineSegment", "float Distance(const Line &in,float *,float *) const", AS_METHOD_FUNCTION_PR(LineSegment, Distance, (const Line &,float *,float *) const, float), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(float * (==float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("LineSegment", "float Distance(const LineSegment &in,float *,float *) const", AS_METHOD_FUNCTION_PR(LineSegment, Distance, (const LineSegment &,float *,float *) const, float), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(float * (==float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("LineSegment", "bool Intersects(const Plane &in,float *) const", AS_METHOD_FUNCTION_PR(LineSegment, Intersects, (const Plane &,float *) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(float * (==float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("LineSegment", "bool Intersects(const Triangle &in,float *,float3 *) const", AS_METHOD_FUNCTION_PR(LineSegment, Intersects, (const Triangle &,float *,float3 *) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(float3 * (==float3 *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("LineSegment", "bool Intersects(const Sphere &in,float3 *,float3 *,float *) const", AS_METHOD_FUNCTION_PR(LineSegment, Intersects, (const Sphere &,float3 *,float3 *,float *) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(float * (==float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("LineSegment", "bool Intersects(const AABB &in,float *,float *) const", AS_METHOD_FUNCTION_PR(LineSegment, Intersects, (const AABB &,float *,float *) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(float * (==float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("LineSegment", "bool Intersects(const OBB &in,float *,float *) const", AS_METHOD_FUNCTION_PR(LineSegment, Intersects, (const OBB &,float *,float *) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(const Polygon & (==const Polygon &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("LineSegment", "bool Intersects(const Polygon &in) const", AS_METHOD_FUNCTION_PR(LineSegment, Intersects, (const Polygon &) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(const Polyhedron & (==const Polyhedron &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("LineSegment", "bool Intersects(const Polyhedron &in) const", AS_METHOD_FUNCTION_PR(LineSegment, Intersects, (const Polyhedron &) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(const Polyhedron & (==const Polyhedron &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("OBB", "bool SetFrom(const Polyhedron &in)", AS_METHOD_FUNCTION_PR(OBB, SetFrom, (const Polyhedron &), bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const float3 * (==const float3 *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("OBB", "void SetFromApproximate(const float3 *,int)", AS_METHOD_FUNCTION_PR(OBB, SetFromApproximate, (const float3 *,int), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(Polyhedron(==Polyhedron) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("OBB", "Polyhedron ToPolyhedron() const", AS_METHOD_FUNCTION_PR(OBB, ToPolyhedron, () const, Polyhedron), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(float3 * (==float3 *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("OBB", "void GetCornerPoints(float3 *) const", AS_METHOD_FUNCTION_PR(OBB, GetCornerPoints, (float3 *) const, void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(Plane * (==Plane *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("OBB", "void GetFacePlanes(Plane *) const", AS_METHOD_FUNCTION_PR(OBB, GetFacePlanes, (Plane *) const, void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(const Polygon & (==const Polygon &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("OBB", "bool Contains(const Polygon &in) const", AS_METHOD_FUNCTION_PR(OBB, Contains, (const Polygon &) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(const Polyhedron & (==const Polyhedron &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("OBB", "bool Contains(const Polyhedron &in) const", AS_METHOD_FUNCTION_PR(OBB, Contains, (const Polyhedron &) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(float * (==float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("OBB", "bool Intersects(const Ray &in,float *,float *) const", AS_METHOD_FUNCTION_PR(OBB, Intersects, (const Ray &,float *,float *) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(float * (==float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("OBB", "bool Intersects(const Line &in,float *,float *) const", AS_METHOD_FUNCTION_PR(OBB, Intersects, (const Line &,float *,float *) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(float * (==float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("OBB", "bool Intersects(const LineSegment &in,float *,float *) const", AS_METHOD_FUNCTION_PR(OBB, Intersects, (const LineSegment &,float *,float *) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(float3 * (==float3 *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("OBB", "bool Intersects(const Sphere &in,float3 *) const", AS_METHOD_FUNCTION_PR(OBB, Intersects, (const Sphere &,float3 *) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(const Polygon & (==const Polygon &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("OBB", "bool Intersects(const Polygon &in) const", AS_METHOD_FUNCTION_PR(OBB, Intersects, (const Polygon &) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(const Polyhedron & (==const Polyhedron &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("OBB", "bool Intersects(const Polyhedron &in) const", AS_METHOD_FUNCTION_PR(OBB, Intersects, (const Polyhedron &) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(float3 * (==float3 *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("OBB", "void Triangulate(int,int,int,float3 *,float3 *,float2 *) const", AS_METHOD_FUNCTION_PR(OBB, Triangulate, (int,int,int,float3 *,float3 *,float2 *) const, void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(float3 * (==float3 *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("OBB", "void ToEdgeList(float3 *) const", AS_METHOD_FUNCTION_PR(OBB, ToEdgeList, (float3 *) const, void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(const float3 * (==const float3 *) is not known to angelscript)*/ 	//.classmethod(// /*(const float3 * (==const float3 *) is not known to angelscript)*/ 	//.classmethod(	//.classmethod(	//.classmethod(
...
// /*(bool * (==bool *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Plane", "Line Project(const Line &in,bool *) const", AS_METHOD_FUNCTION_PR(Plane, Project, (const Line &,bool *) const, Line), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(bool * (==bool *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Plane", "Ray Project(const Ray &in,bool *) const", AS_METHOD_FUNCTION_PR(Plane, Project, (const Ray &,bool *) const, Ray), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(Polygon(==Polygon) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Plane", "Polygon Project(const Polygon &in) const", AS_METHOD_FUNCTION_PR(Plane, Project, (const Polygon &) const, Polygon), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(const Polygon & (==const Polygon &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Plane", "bool Contains(const Polygon &in,float) const", AS_METHOD_FUNCTION_PR(Plane, Contains, (const Polygon &,float) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(Line * (==Line *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Plane", "bool Intersects(const Plane &in,const Plane &in,Line *,float3 *) const", AS_METHOD_FUNCTION_PR(Plane, Intersects, (const Plane &,const Plane &,Line *,float3 *) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(Line * (==Line *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Plane", "bool Intersects(const Plane &in,Line *) const", AS_METHOD_FUNCTION_PR(Plane, Intersects, (const Plane &,Line *) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(float * (==float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Plane", "bool Intersects(const Ray &in,float *) const", AS_METHOD_FUNCTION_PR(Plane, Intersects, (const Ray &,float *) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(float * (==float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Plane", "bool Intersects(const Line &in,float *) const", AS_METHOD_FUNCTION_PR(Plane, Intersects, (const Line &,float *) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(float * (==float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Plane", "bool Intersects(const LineSegment &in,float *) const", AS_METHOD_FUNCTION_PR(Plane, Intersects, (const LineSegment &,float *) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(const Polygon & (==const Polygon &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Plane", "bool Intersects(const Polygon &in) const", AS_METHOD_FUNCTION_PR(Plane, Intersects, (const Polygon &) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const Polyhedron & (==const Polyhedron &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Plane", "bool Intersects(const Polyhedron &in) const", AS_METHOD_FUNCTION_PR(Plane, Intersects, (const Polyhedron &) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(float3 * (==float3 *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Plane", "int Intersects(const Circle &in,float3 *,float3 *) const", AS_METHOD_FUNCTION_PR(Plane, Intersects, (const Circle &,float3 *,float3 *) const, int), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(float * (==float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Ray", "float Distance(const float3 &in,float *) const", AS_METHOD_FUNCTION_PR(Ray, Distance, (const float3 &,float *) const, float), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(float * (==float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Ray", "float Distance(const Ray &in,float *,float *) const", AS_METHOD_FUNCTION_PR(Ray, Distance, (const Ray &,float *,float *) const, float), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(float * (==float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Ray", "float Distance(const Line &in,float *,float *) const", AS_METHOD_FUNCTION_PR(Ray, Distance, (const Line &,float *,float *) const, float), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(float * (==float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Ray", "float Distance(const LineSegment &in,float *,float *) const", AS_METHOD_FUNCTION_PR(Ray, Distance, (const LineSegment &,float *,float *) const, float), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(float * (==float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Ray", "float3 ClosestPoint(const float3 &in,float *) const", AS_METHOD_FUNCTION_PR(Ray, ClosestPoint, (const float3 &,float *) const, float3), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(float * (==float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Ray", "float3 ClosestPoint(const Ray &in,float *,float *) const", AS_METHOD_FUNCTION_PR(Ray, ClosestPoint, (const Ray &,float *,float *) const, float3), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(float * (==float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Ray", "float3 ClosestPoint(const Line &in,float *,float *) const", AS_METHOD_FUNCTION_PR(Ray, ClosestPoint, (const Line &,float *,float *) const, float3), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(float * (==float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Ray", "float3 ClosestPoint(const LineSegment &in,float *,float *) const", AS_METHOD_FUNCTION_PR(Ray, ClosestPoint, (const LineSegment &,float *,float *) const, float3), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(float * (==float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Ray", "bool Intersects(const Triangle &in,float *,float3 *) const", AS_METHOD_FUNCTION_PR(Ray, Intersects, (const Triangle &,float *,float3 *) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(float * (==float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Ray", "bool Intersects(const Plane &in,float *) const", AS_METHOD_FUNCTION_PR(Ray, Intersects, (const Plane &,float *) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(float3 * (==float3 *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Ray", "bool Intersects(const Sphere &in,float3 *,float3 *,float *) const", AS_METHOD_FUNCTION_PR(Ray, Intersects, (const Sphere &,float3 *,float3 *,float *) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(float * (==float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Ray", "bool Intersects(const AABB &in,float *,float *) const", AS_METHOD_FUNCTION_PR(Ray, Intersects, (const AABB &,float *,float *) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(float * (==float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Ray", "bool Intersects(const OBB &in,float *,float *) const", AS_METHOD_FUNCTION_PR(Ray, Intersects, (const OBB &,float *,float *) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(const Polygon & (==const Polygon &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Ray", "bool Intersects(const Polygon &in) const", AS_METHOD_FUNCTION_PR(Ray, Intersects, (const Polygon &) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(const Polyhedron & (==const Polyhedron &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Ray", "bool Intersects(const Polyhedron &in) const", AS_METHOD_FUNCTION_PR(Ray, Intersects, (const Polyhedron &) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(const Polygon & (==const Polygon &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Sphere", "bool Contains(const Polygon &in) const", AS_METHOD_FUNCTION_PR(Sphere, Contains, (const Polygon &) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(const Polyhedron & (==const Polyhedron &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Sphere", "bool Contains(const Polyhedron &in) const", AS_METHOD_FUNCTION_PR(Sphere, Contains, (const Polyhedron &) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(float3 * (==float3 *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Sphere", "bool Intersects(const LineSegment &in,float3 *,float3 *,float *) const", AS_METHOD_FUNCTION_PR(Sphere, Intersects, (const LineSegment &,float3 *,float3 *,float *) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(float3 * (==float3 *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Sphere", "bool Intersects(const Line &in,float3 *,float3 *,float *) const", AS_METHOD_FUNCTION_PR(Sphere, Intersects, (const Line &,float3 *,float3 *,float *) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(float3 * (==float3 *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Sphere", "bool Intersects(const Ray &in,float3 *,float3 *,float *) const", AS_METHOD_FUNCTION_PR(Sphere, Intersects, (const Ray &,float3 *,float3 *,float *) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(float3 * (==float3 *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Sphere", "bool Intersects(const AABB &in,float3 *) const", AS_METHOD_FUNCTION_PR(Sphere, Intersects, (const AABB &,float3 *) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(float3 * (==float3 *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Sphere", "bool Intersects(const OBB &in,float3 *) const", AS_METHOD_FUNCTION_PR(Sphere, Intersects, (const OBB &,float3 *) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(float3 * (==float3 *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Sphere", "bool Intersects(const Triangle &in,float3 *) const", AS_METHOD_FUNCTION_PR(Sphere, Intersects, (const Triangle &,float3 *) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(const Polygon & (==const Polygon &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Sphere", "bool Intersects(const Polygon &in) const", AS_METHOD_FUNCTION_PR(Sphere, Intersects, (const Polygon &) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(const Polyhedron & (==const Polyhedron &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Sphere", "bool Intersects(const Polyhedron &in) const", AS_METHOD_FUNCTION_PR(Sphere, Intersects, (const Polyhedron &) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(const float3 * (==const float3 *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Sphere", "void Enclose(const float3 *,int)", AS_METHOD_FUNCTION_PR(Sphere, Enclose, (const float3 *,int), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(float3 * (==float3 *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Sphere", "int Triangulate(float3 *,float3 *,float2 *,int)", AS_METHOD_FUNCTION_PR(Sphere, Triangulate, (float3 *,float3 *,float2 *,int), int), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(const float3 * (==const float3 *) is not known to angelscript)*/ 	//.classmethod(// /*(const float3 * (==const float3 *) is not known to angelscript)*/ 	//.classmethod(// /*(inout refs are not supported for value types)*/ 	//.classmethod(// /*(inout refs are not supported for value types)*/ 	//.classmethod(// /*(inout refs are not supported for value types)*/ 	//.classmethod(
...
// /*(Polygon(==Polygon) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Triangle", "Polygon ToPolygon() const", AS_METHOD_FUNCTION_PR(Triangle, ToPolygon, () const, Polygon), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(Polyhedron(==Polyhedron) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Triangle", "Polyhedron ToPolyhedron() const", AS_METHOD_FUNCTION_PR(Triangle, ToPolyhedron, () const, Polyhedron), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(float * (==float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Triangle", "bool Intersects(const LineSegment &in,float *,float3 *) const", AS_METHOD_FUNCTION_PR(Triangle, Intersects, (const LineSegment &,float *,float3 *) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(float * (==float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Triangle", "bool Intersects(const Line &in,float *,float3 *) const", AS_METHOD_FUNCTION_PR(Triangle, Intersects, (const Line &,float *,float3 *) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(float * (==float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Triangle", "bool Intersects(const Ray &in,float *,float3 *) const", AS_METHOD_FUNCTION_PR(Triangle, Intersects, (const Ray &,float *,float3 *) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(float3 * (==float3 *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Triangle", "bool Intersects(const Sphere &in,float3 *) const", AS_METHOD_FUNCTION_PR(Triangle, Intersects, (const Sphere &,float3 *) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(LineSegment * (==LineSegment *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Triangle", "bool Intersects(const Triangle &in,LineSegment *) const", AS_METHOD_FUNCTION_PR(Triangle, Intersects, (const Triangle &,LineSegment *) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(const Polygon & (==const Polygon &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Triangle", "bool Intersects(const Polygon &in) const", AS_METHOD_FUNCTION_PR(Triangle, Intersects, (const Polygon &) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(const Polyhedron & (==const Polyhedron &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Triangle", "bool Intersects(const Polyhedron &in) const", AS_METHOD_FUNCTION_PR(Triangle, Intersects, (const Polyhedron &) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(float3 * (==float3 *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Triangle", "float3 ClosestPoint(const LineSegment &in,float3 *) const", AS_METHOD_FUNCTION_PR(Triangle, ClosestPoint, (const LineSegment &,float3 *) const, float3), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(float * (==float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Triangle", "float3 ClosestPoint(const Line &in,float *,float *,float *) const", AS_METHOD_FUNCTION_PR(Triangle, ClosestPoint, (const Line &,float *,float *,float *) const, float3), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(float3 * (==float3 *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Triangle", "float3 ClosestPoint(const Triangle &in,float3 *) const", AS_METHOD_FUNCTION_PR(Triangle, ClosestPoint, (const Triangle &,float3 *) const, float3), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(float * (==float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Triangle", "float3 ClosestPointToTriangleEdge(const Line &in,float *,float *,float *) const", AS_METHOD_FUNCTION_PR(Triangle, ClosestPointToTriangleEdge, (const Line &,float *,float *,float *) const, float3), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(float * (==float *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Triangle", "float3 ClosestPointToTriangleEdge(const LineSegment &in,float *,float *,float *) const", AS_METHOD_FUNCTION_PR(Triangle, ClosestPointToTriangleEdge, (const LineSegment &,float *,float *,float *) const, float3), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(inout refs are not supported for value types)*/ 	r = engine->RegisterObjectMethod("Triangle", "float3 RandomPointOnEdge(LCG &) const", AS_METHOD_FUNCTION_PR(Triangle, RandomPointOnEdge, (LCG &) const, float3), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	...
	//.classmethod(	//.classmethod(	//.classmethod(	//.classmethod(	//.classmethod(	//.classmethod(	//.classmethod(// /*(unsigned long(==uint32) is not known to angelscript)*/ 	//.classmethod(// /*(unsigned long(==uint32) is not known to angelscript)*/ 	//.classmethod(// /*(unsigned long(==uint32) is not known to angelscript)*/ 	//.classmethod(// /*(tick_t(==u64) is not known to angelscript)*/ 	//.classmethod(// /*(tick_t(==u64) is not known to angelscript)*/ 	//.classmethod(// /*(tick_t(==u64) is not known to angelscript)*/ 	//.classmethod(// /*(tick_t(==u64) is not known to angelscript)*/ 	//.classmethod(// /*(tick_t (==u64) is not known to angelscript)*/ 	//.classmethod(// /*(tick_t (==u64) is not known to angelscript)*/ 	//.classmethod(// /*(tick_t (==u64) is not known to angelscript)*/ 	//.classmethod(// /*(tick_t (==u64) is not known to angelscript)*/ 	//.classmethod(// /*(tick_t (==u64) is not known to angelscript)*/ 	//.classmethod(// /*(tick_t (==u64) is not known to angelscript)*/ 	//.classmethod(// /*(tick_t (==u64) is not known to angelscript)*/ 	//.classmethod(// /*(tick_t (==u64) is not known to angelscript)*/ 	//.classmethod(// /*(tick_t (==u64) is not known to angelscript)*/ 	//.classmethod(// /*(tick_t (==u64) is not known to angelscript)*/ 	//.classmethod(// /*(tick_t (==u64) is not known to angelscript)*/ 	//.classmethod(// /*(tick_t (==u64) is not known to angelscript)*/ 	//.classmethod(// /*(tick_t (==u64) is not known to angelscript)*/ 	//.classmethod(
...
// /*(u32 (==boost_uint32_t) is not known to angelscript)*/ 	r = engine->RegisterObjectBehaviour("LCG", asBEHAVE_CONSTRUCT, "void f(boost_uint32_t,boost_uint32_t,boost_uint32_t,boost_uint32_t)", AS_CONSTRUCTOR(LCG_ctor_u32_u32_u32_u32, LCG, (u32,u32,u32,u32)), AS_CTOR_CONVENTION); assert(r >= 0);
// /*(u32 (==boost_uint32_t) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("LCG", "void Seed(boost_uint32_t,boost_uint32_t,boost_uint32_t,boost_uint32_t)", AS_METHOD_FUNCTION_PR(LCG, Seed, (u32,u32,u32,u32), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(u32(==boost_uint32_t) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("LCG", "boost_uint32_t Int()", AS_METHOD_FUNCTION_PR(LCG, Int, (), u32), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(u32(==boost_uint32_t) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("LCG", "boost_uint32_t MaxInt() const", AS_METHOD_FUNCTION_PR(LCG, MaxInt, () const, u32), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(u32(==boost_uint32_t) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("LCG", "boost_uint32_t IntFast()", AS_METHOD_FUNCTION_PR(LCG, IntFast, (), u32), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	...
	// /* TODO */ r = engine->RegisterObjectBehaviour("EC_Placeable", asBEHAVE_FACTORY, "EC_Placeable@ f(Scene @)", AS_FUNCTION(EC_Placeable_Factory_Scene_ptr, EC_Placeable, (Scene *)), AS_CALL_CONVENTION); assert(r >= 0);	// /*(Ogre::SceneNode *(==Ogre_SceneNode *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("EC_Placeable", "Ogre_SceneNode * GetSceneNode() const", AS_METHOD_FUNCTION_PR(EC_Placeable, GetSceneNode, () const, Ogre::SceneNode *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	...
	r = engine->RegisterObjectMethod("EC_Placeable", "void SetOrientationAndScale(const float3x3 &in)", AS_METHOD_FUNCTION_PR(EC_Placeable, SetOrientationAndScale, (const float3x3 &), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("EC_Placeable", "void SetOrientationAndScale(const Quat &in,const float3 &in)", AS_METHOD_FUNCTION_PR(EC_Placeable, SetOrientationAndScale, (const Quat &,const float3 &), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("EC_Placeable", "void SetScale(float,float,float)", AS_METHOD_FUNCTION_PR(EC_Placeable, SetScale, (float,float,float), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("EC_Placeable", "void SetScale(const float3 &in)", AS_METHOD_FUNCTION_PR(EC_Placeable, SetScale, (const float3 &), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("EC_Placeable", "void SetTransform(const float3x3 &in,const float3 &in)", AS_METHOD_FUNCTION_PR(EC_Placeable, SetTransform, (const float3x3 &,const float3 &), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("EC_Placeable", "void SetTransform(const float3x4 &in)", AS_METHOD_FUNCTION_PR(EC_Placeable, SetTransform, (const float3x4 &), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("EC_Placeable", "void SetTransform(const float4x4 &in)", AS_METHOD_FUNCTION_PR(EC_Placeable, SetTransform, (const float4x4 &), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("EC_Placeable", "void SetTransform(const Quat &in,const float3 &in)", AS_METHOD_FUNCTION_PR(EC_Placeable, SetTransform, (const Quat &,const float3 &), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("EC_Placeable", "void SetTransform(const Quat &in,const float3 &in,const float3 &in)", AS_METHOD_FUNCTION_PR(EC_Placeable, SetTransform, (const Quat &,const float3 &,const float3 &), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("EC_Placeable", "void SetWorldTransform(const float3x3 &in,const float3 &in)", AS_METHOD_FUNCTION_PR(EC_Placeable, SetWorldTransform, (const float3x3 &,const float3 &), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("EC_Placeable", "void SetWorldTransform(const float3x4 &in)", AS_METHOD_FUNCTION_PR(EC_Placeable, SetWorldTransform, (const float3x4 &), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("EC_Placeable", "void SetWorldTransform(const float4x4 &in)", AS_METHOD_FUNCTION_PR(EC_Placeable, SetWorldTransform, (const float4x4 &), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("EC_Placeable", "void SetWorldTransform(const Quat &in,const float3 &in)", AS_METHOD_FUNCTION_PR(EC_Placeable, SetWorldTransform, (const Quat &,const float3 &), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("EC_Placeable", "void SetWorldTransform(const Quat &in,const float3 &in,const float3 &in)", AS_METHOD_FUNCTION_PR(EC_Placeable, SetWorldTransform, (const Quat &,const float3 &,const float3 &), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("EC_Placeable", "float3 WorldPosition() const", AS_METHOD_FUNCTION_PR(EC_Placeable, WorldPosition, () const, float3), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("EC_Placeable", "Quat WorldOrientation() const", AS_METHOD_FUNCTION_PR(EC_Placeable, WorldOrientation, () const, Quat), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("EC_Placeable", "float3 WorldScale() const", AS_METHOD_FUNCTION_PR(EC_Placeable, WorldScale, () const, float3), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("EC_Placeable", "float3 Position() const", AS_METHOD_FUNCTION_PR(EC_Placeable, Position, () const, float3), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("EC_Placeable", "Quat Orientation() const", AS_METHOD_FUNCTION_PR(EC_Placeable, Orientation, () const, Quat), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("EC_Placeable", "float3 Scale() const", AS_METHOD_FUNCTION_PR(EC_Placeable, Scale, () const, float3), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("EC_Placeable", "float3x4 LocalToWorld() const", AS_METHOD_FUNCTION_PR(EC_Placeable, LocalToWorld, () const, float3x4), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("EC_Placeable", "float3x4 WorldToLocal() const", AS_METHOD_FUNCTION_PR(EC_Placeable, WorldToLocal, () const, float3x4), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("EC_Placeable", "float3x4 LocalToParent() const", AS_METHOD_FUNCTION_PR(EC_Placeable, LocalToParent, () const, float3x4), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("EC_Placeable", "float3x4 ParentToLocal() const", AS_METHOD_FUNCTION_PR(EC_Placeable, ParentToLocal, () const, float3x4), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("EC_Placeable", "void Show()", AS_METHOD_FUNCTION_PR(EC_Placeable, Show, (), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("EC_Placeable", "void Hide()", AS_METHOD_FUNCTION_PR(EC_Placeable, Hide, (), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("EC_Placeable", "void ToggleVisibility()", AS_METHOD_FUNCTION_PR(EC_Placeable, ToggleVisibility, (), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("EC_Placeable", "bool IsAttached() const", AS_METHOD_FUNCTION_PR(EC_Placeable, IsAttached, () const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("EC_Placeable", "void SetParent(Entity @,bool)", AS_METHOD_FUNCTION_PR(EC_Placeable, SetParent, (Entity *,bool), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QString (==QString) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("EC_Placeable", "void SetParent(Entity @,QString,bool)", AS_METHOD_FUNCTION_PR(EC_Placeable, SetParent, (Entity *,QString,bool), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(EntityList(==std_list<EntityPtr>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("EC_Placeable", "std_list<EntityPtr> Children() const", AS_METHOD_FUNCTION_PR(EC_Placeable, Children, () const, EntityList), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("EC_Placeable", "void DumpNodeHierarhy()", AS_METHOD_FUNCTION_PR(EC_Placeable, DumpNodeHierarhy, (), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("EC_Placeable", "Entity @ ParentPlaceableEntity() const", AS_METHOD_FUNCTION_PR(EC_Placeable, ParentPlaceableEntity, () const, Entity *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("EC_Placeable", "EC_Placeable @ ParentPlaceableComponent() const", AS_METHOD_FUNCTION_PR(EC_Placeable, ParentPlaceableComponent, () const, EC_Placeable *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("EC_Placeable", "bool IsGrandparentOf(Entity @) const", AS_METHOD_FUNCTION_PR(EC_Placeable, IsGrandparentOf, (Entity *) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("EC_Placeable", "bool IsGrandparentOf(EC_Placeable @) const", AS_METHOD_FUNCTION_PR(EC_Placeable, IsGrandparentOf, (EC_Placeable *) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("EC_Placeable", "bool IsGrandchildOf(Entity @) const", AS_METHOD_FUNCTION_PR(EC_Placeable, IsGrandchildOf, (Entity *) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("EC_Placeable", "bool IsGrandchildOf(EC_Placeable @) const", AS_METHOD_FUNCTION_PR(EC_Placeable, IsGrandchildOf, (EC_Placeable *) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(EntityList(==std_list<EntityPtr>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("EC_Placeable", "std_list<EntityPtr> Grandchildren(Entity @) const", AS_METHOD_FUNCTION_PR(EC_Placeable, Grandchildren, (Entity *) const, EntityList), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);



	r = engine->RegisterObjectProperty("Transform", "float3 pos", asOFFSET(Transform, pos)); assert(r >= 0);
	r = engine->RegisterObjectProperty("Transform", "float3 rot", asOFFSET(Transform, rot)); assert(r >= 0);
	r = engine->RegisterObjectProperty("Transform", "float3 scale", asOFFSET(Transform, scale)); assert(r >= 0);
	r = engine->RegisterObjectBehaviour("Transform", asBEHAVE_CONSTRUCT, "void f()", AS_CONSTRUCTOR(Transform_ctor_, Transform, ()), AS_CTOR_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectBehaviour("Transform", asBEHAVE_CONSTRUCT, "void f(const float3 &in,const float3 &in,const float3 &in)", AS_CONSTRUCTOR(Transform_ctor_const_float3_ref_const_float3_ref_const_float3_ref, Transform, (const float3 &,const float3 &,const float3 &)), AS_CTOR_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectBehaviour("Transform", asBEHAVE_CONSTRUCT, "void f(const float3x3 &in)", AS_CONSTRUCTOR(Transform_ctor_const_float3x3_ref, Transform, (const float3x3 &)), AS_CTOR_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectBehaviour("Transform", asBEHAVE_CONSTRUCT, "void f(const float3x4 &in)", AS_CONSTRUCTOR(Transform_ctor_const_float3x4_ref, Transform, (const float3x4 &)), AS_CTOR_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectBehaviour("Transform", asBEHAVE_CONSTRUCT, "void f(const float4x4 &in)", AS_CONSTRUCTOR(Transform_ctor_const_float4x4_ref, Transform, (const float4x4 &)), AS_CTOR_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Transform", "void SetPos(const float3 &in)", AS_METHOD_FUNCTION_PR(Transform, SetPos, (const float3 &), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Transform", "void SetPos(float,float,float)", AS_METHOD_FUNCTION_PR(Transform, SetPos, (float,float,float), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Transform", "void SetRotation(float,float,float)", AS_METHOD_FUNCTION_PR(Transform, SetRotation, (float,float,float), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Transform", "void SetScale(float,float,float)", AS_METHOD_FUNCTION_PR(Transform, SetScale, (float,float,float), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Transform", "void SetScale(const float3 &in)", AS_METHOD_FUNCTION_PR(Transform, SetScale, (const float3 &), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Transform", "float3x4 ToFloat3x4() const", AS_METHOD_FUNCTION_PR(Transform, ToFloat3x4, () const, float3x4), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Transform", "float4x4 ToFloat4x4() const", AS_METHOD_FUNCTION_PR(Transform, ToFloat4x4, () const, float4x4), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Transform", "void FromFloat3x4(const float3x4 &in)", AS_METHOD_FUNCTION_PR(Transform, FromFloat3x4, (const float3x4 &), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Transform", "void FromFloat4x4(const float4x4 &in)", AS_METHOD_FUNCTION_PR(Transform, FromFloat4x4, (const float4x4 &), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Transform", "void SetRotationAndScale(const float3x3 &in)", AS_METHOD_FUNCTION_PR(Transform, SetRotationAndScale, (const float3x3 &), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Transform", "void SetOrientation(const float3x3 &in)", AS_METHOD_FUNCTION_PR(Transform, SetOrientation, (const float3x3 &), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Transform", "void SetOrientation(const Quat &in)", AS_METHOD_FUNCTION_PR(Transform, SetOrientation, (const Quat &), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Transform", "float3x3 Orientation3x3() const", AS_METHOD_FUNCTION_PR(Transform, Orientation3x3, () const, float3x3), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Transform", "Quat Orientation() const", AS_METHOD_FUNCTION_PR(Transform, Orientation, () const, Quat), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Transform", "Transform opMul(const Transform &in) const", AS_METHOD_FUNCTION_PR(Transform, operator*, (const Transform &) const, Transform), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Transform", "Transform Mul(const Transform &in) const", AS_METHOD_FUNCTION_PR(Transform, Mul, (const Transform &) const, Transform), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(Implicit conversion operators are not supported)*/ 	r = engine->RegisterObjectMethod("Transform", " operator float3x4() const", AS_METHOD_FUNCTION_PR(Transform, operator float3x4, () const, ), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(Implicit conversion operators are not supported)*/ 	r = engine->RegisterObjectMethod("Transform", " operator float4x4() const", AS_METHOD_FUNCTION_PR(Transform, operator float4x4, () const, ), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	r = engine->RegisterObjectMethod("Transform", "bool opEquals(const Transform &in) const", AS_METHOD_FUNCTION_PR(Transform, operator==, (const Transform &) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(operator != is implemented automatically by exposing operator == as opEquals)*/ 	r = engine->RegisterObjectMethod("Transform", "bool operator!=(const Transform &in) const", AS_METHOD_FUNCTION_PR(Transform, operator!=, (const Transform &) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(Implicit conversion operators are not supported)*/ 	r = engine->RegisterObjectMethod("Transform", " operator QString() const", AS_METHOD_FUNCTION_PR(Transform, operator QString, () const, ), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QString(==QString) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Transform", "QString ToString() const", AS_METHOD_FUNCTION_PR(Transform, ToString, () const, QString), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QString(==QString) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Transform", "QString toString() const", AS_METHOD_FUNCTION_PR(Transform, toString, () const, QString), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QString(==QString) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Transform", "QString SerializeToString() const", AS_METHOD_FUNCTION_PR(Transform, SerializeToString, () const, QString), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const char * (==const int8 *) is not known to angelscript)*/ 	//.classmethod(// /*(const QString & (==const QString &) is not known to angelscript)*/ 	//.classmethod(
