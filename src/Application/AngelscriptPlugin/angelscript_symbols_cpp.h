...
// /*(Framework * is not known to angelscript)*/ 	//.classmethod(// /*(Framework * is not known to angelscript)*/ 	//.classmethod(// /*(StaticPluginRegistry * is not known to angelscript)*/ 	//.classmethod(// /*(UiAPI * is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Framework", "UiAPI * Ui() const", AS_METHOD_FUNCTION_PR(Framework, Ui, () const, UiAPI *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(InputAPI * is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Framework", "InputAPI * Input() const", AS_METHOD_FUNCTION_PR(Framework, Input, () const, InputAPI *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(FrameAPI * is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Framework", "FrameAPI * Frame() const", AS_METHOD_FUNCTION_PR(Framework, Frame, () const, FrameAPI *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ConsoleAPI * is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Framework", "ConsoleAPI * Console() const", AS_METHOD_FUNCTION_PR(Framework, Console, () const, ConsoleAPI *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(AudioAPI * is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Framework", "AudioAPI * Audio() const", AS_METHOD_FUNCTION_PR(Framework, Audio, () const, AudioAPI *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(AssetAPI * is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Framework", "AssetAPI * Asset() const", AS_METHOD_FUNCTION_PR(Framework, Asset, () const, AssetAPI *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(SceneAPI * is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Framework", "SceneAPI * Scene() const", AS_METHOD_FUNCTION_PR(Framework, Scene, () const, SceneAPI *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ConfigAPI * is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Framework", "ConfigAPI * Config() const", AS_METHOD_FUNCTION_PR(Framework, Config, () const, ConfigAPI *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(PluginAPI * is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Framework", "PluginAPI * Plugins() const", AS_METHOD_FUNCTION_PR(Framework, Plugins, () const, PluginAPI *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(VersionInfo * is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Framework", "VersionInfo * ApiVersion() const", AS_METHOD_FUNCTION_PR(Framework, ApiVersion, () const, VersionInfo *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(VersionInfo * is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Framework", "VersionInfo * ApplicationVersion() const", AS_METHOD_FUNCTION_PR(Framework, ApplicationVersion, () const, VersionInfo *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(IModule * is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Framework", "IModule * GetModuleByName(const QString &in) const", AS_METHOD_FUNCTION_PR(Framework, GetModuleByName, (const QString &) const, IModule *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(QString is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Framework", "bool HasCommandLineParameter(const QString &in) const", AS_METHOD_FUNCTION_PR(Framework, HasCommandLineParameter, (const QString &) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QStringList is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Framework", "QStringList CommandLineParameters(const QString &in) const", AS_METHOD_FUNCTION_PR(Framework, CommandLineParameters, (const QString &) const, QStringList), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	...
	// /*(boost::shared_ptr< T > is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("SceneAPI", "boost::shared_ptr< T > CreateComponent(Scene *,const QString &in) const", AS_METHOD_FUNCTION_PR(SceneAPI, CreateComponent, (Scene *,const QString &) const, boost::shared_ptr< T >), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(const QStringList & is not known to angelscript)*/ 	//.classmethod(// /*(ScenePtr is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("SceneAPI", "ScenePtr GetScene(const QString &in) const", AS_METHOD_FUNCTION_PR(SceneAPI, GetScene, (const QString &) const, ScenePtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(Scene * is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("SceneAPI", "Scene * MainCameraScene()", AS_METHOD_FUNCTION_PR(SceneAPI, MainCameraScene, (), Scene *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ScenePtr is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("SceneAPI", "ScenePtr CreateScene(const QString &in,bool,bool)", AS_METHOD_FUNCTION_PR(SceneAPI, CreateScene, (const QString &,bool,bool), ScenePtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QString is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("SceneAPI", "void RemoveScene(const QString &in)", AS_METHOD_FUNCTION_PR(SceneAPI, RemoveScene, (const QString &), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QString is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("SceneAPI", "bool IsComponentFactoryRegistered(const QString &in) const", AS_METHOD_FUNCTION_PR(SceneAPI, IsComponentFactoryRegistered, (const QString &) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ComponentFactoryPtr is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("SceneAPI", "void RegisterComponentFactory(const ComponentFactoryPtr &in)", AS_METHOD_FUNCTION_PR(SceneAPI, RegisterComponentFactory, (const ComponentFactoryPtr &), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ComponentPtr is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("SceneAPI", "ComponentPtr CreateComponentByName(Scene *,const QString &in,const QString &in) const", AS_METHOD_FUNCTION_PR(SceneAPI, CreateComponentByName, (Scene *,const QString &,const QString &) const, ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ComponentPtr is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("SceneAPI", "ComponentPtr CreateComponentById(Scene *,u32,const QString &in) const", AS_METHOD_FUNCTION_PR(SceneAPI, CreateComponentById, (Scene *,u32,const QString &) const, ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QString is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("SceneAPI", "QString GetComponentTypeName(u32) const", AS_METHOD_FUNCTION_PR(SceneAPI, GetComponentTypeName, (u32) const, QString), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(u32 is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("SceneAPI", "u32 GetComponentTypeId(const QString &in) const", AS_METHOD_FUNCTION_PR(SceneAPI, GetComponentTypeId, (const QString &) const, u32), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QString is not known to angelscript)*/ 	//.classmethod(// /*(u32 is not known to angelscript)*/ 	//.classmethod(// /*(IAttribute * is not known to angelscript)*/ 	//.classmethod(// /*(IAttribute * is not known to angelscript)*/ 	//.classmethod(// /*(QStringList is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("SceneAPI", "QStringList ComponentTypes() const", AS_METHOD_FUNCTION_PR(SceneAPI, ComponentTypes, () const, QStringList), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QString is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("SceneAPI", "bool HasScene(const QString &in) const", AS_METHOD_FUNCTION_PR(SceneAPI, HasScene, (const QString &) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);



	// /*(const QString & is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "const QString & Name() const", AS_METHOD_FUNCTION_PR(Scene, Name, () const, const QString &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(EntityPtr is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "EntityPtr CreateEntity(entity_id_t,const QStringList &in,AttributeChange::Type,bool,bool)", AS_METHOD_FUNCTION_PR(Scene, CreateEntity, (entity_id_t,const QStringList &,AttributeChange::Type,bool,bool), EntityPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(EntityPtr is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "EntityPtr CreateLocalEntity(const QStringList &in,AttributeChange::Type,bool)", AS_METHOD_FUNCTION_PR(Scene, CreateLocalEntity, (const QStringList &,AttributeChange::Type,bool), EntityPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(EntityPtr is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "EntityPtr EntityById(entity_id_t) const", AS_METHOD_FUNCTION_PR(Scene, EntityById, (entity_id_t) const, EntityPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(EntityPtr is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "EntityPtr EntityByName(const QString &in) const", AS_METHOD_FUNCTION_PR(Scene, EntityByName, (const QString &) const, EntityPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QString is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "bool IsUniqueName(const QString &in) const", AS_METHOD_FUNCTION_PR(Scene, IsUniqueName, (const QString &) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(entity_id_t is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "bool HasEntity(entity_id_t) const", AS_METHOD_FUNCTION_PR(Scene, HasEntity, (entity_id_t) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(entity_id_t is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "bool RemoveEntity(entity_id_t,AttributeChange::Type)", AS_METHOD_FUNCTION_PR(Scene, RemoveEntity, (entity_id_t,AttributeChange::Type), bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(AttributeChange::Type is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "void RemoveAllEntities(bool,AttributeChange::Type)", AS_METHOD_FUNCTION_PR(Scene, RemoveAllEntities, (bool,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(entity_id_t is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "entity_id_t NextFreeId()", AS_METHOD_FUNCTION_PR(Scene, NextFreeId, (), entity_id_t), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(entity_id_t is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "entity_id_t NextFreeIdLocal()", AS_METHOD_FUNCTION_PR(Scene, NextFreeIdLocal, (), entity_id_t), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(EntityList is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "EntityList EntitiesWithComponent(const QString &in,const QString &in) const", AS_METHOD_FUNCTION_PR(Scene, EntitiesWithComponent, (const QString &,const QString &) const, EntityList), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(EntityList is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "EntityList FindEntities(const QRegExp &in) const", AS_METHOD_FUNCTION_PR(Scene, FindEntities, (const QRegExp &) const, EntityList), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(EntityList is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "EntityList FindEntities(const QString &in) const", AS_METHOD_FUNCTION_PR(Scene, FindEntities, (const QString &) const, EntityList), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(EntityList is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "EntityList FindEntitiesContaining(const QString &in) const", AS_METHOD_FUNCTION_PR(Scene, FindEntitiesContaining, (const QString &) const, EntityList), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QList< Entity * > is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "QList< Entity * > LoadSceneXML(const QString &in,bool,bool,AttributeChange::Type)", AS_METHOD_FUNCTION_PR(Scene, LoadSceneXML, (const QString &,bool,bool,AttributeChange::Type), QList< Entity * >), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QByteArray is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "QByteArray GetSceneXML(bool,bool) const", AS_METHOD_FUNCTION_PR(Scene, GetSceneXML, (bool,bool) const, QByteArray), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QString is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "bool SaveSceneXML(const QString &in,bool,bool)", AS_METHOD_FUNCTION_PR(Scene, SaveSceneXML, (const QString &,bool,bool), bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QList< Entity * > is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "QList< Entity * > LoadSceneBinary(const QString &in,bool,bool,AttributeChange::Type)", AS_METHOD_FUNCTION_PR(Scene, LoadSceneBinary, (const QString &,bool,bool,AttributeChange::Type), QList< Entity * >), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QString is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "bool SaveSceneBinary(const QString &in,bool,bool)", AS_METHOD_FUNCTION_PR(Scene, SaveSceneBinary, (const QString &,bool,bool), bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QList< Entity * > is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "QList< Entity * > CreateContentFromXml(const QString &in,bool,AttributeChange::Type)", AS_METHOD_FUNCTION_PR(Scene, CreateContentFromXml, (const QString &,bool,AttributeChange::Type), QList< Entity * >), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QList< Entity * > is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "QList< Entity * > CreateContentFromXml(const QDomDocument &in,bool,AttributeChange::Type)", AS_METHOD_FUNCTION_PR(Scene, CreateContentFromXml, (const QDomDocument &,bool,AttributeChange::Type), QList< Entity * >), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QList< Entity * > is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "QList< Entity * > CreateContentFromBinary(const QString &in,bool,AttributeChange::Type)", AS_METHOD_FUNCTION_PR(Scene, CreateContentFromBinary, (const QString &,bool,AttributeChange::Type), QList< Entity * >), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QList< Entity * > is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "QList< Entity * > CreateContentFromBinary(const char *,int,bool,AttributeChange::Type)", AS_METHOD_FUNCTION_PR(Scene, CreateContentFromBinary, (const char *,int,bool,AttributeChange::Type), QList< Entity * >), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(UserConnection * is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "bool AllowModifyEntity(UserConnection *,Entity *)", AS_METHOD_FUNCTION_PR(Scene, AllowModifyEntity, (UserConnection *,Entity *), bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(Entity * is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "void EmitEntityCreated(Entity *,AttributeChange::Type)", AS_METHOD_FUNCTION_PR(Scene, EmitEntityCreated, (Entity *,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(EntityPtr is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "EntityPtr GetEntity(entity_id_t) const", AS_METHOD_FUNCTION_PR(Scene, GetEntity, (entity_id_t) const, EntityPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(EntityPtr is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "EntityPtr GetEntityByName(const QString &in) const", AS_METHOD_FUNCTION_PR(Scene, GetEntityByName, (const QString &) const, EntityPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(EntityList is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "EntityList GetEntitiesWithComponent(const QString &in,const QString &in) const", AS_METHOD_FUNCTION_PR(Scene, GetEntitiesWithComponent, (const QString &,const QString &) const, EntityList), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(EntityList is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "EntityList GetAllEntities() const", AS_METHOD_FUNCTION_PR(Scene, GetAllEntities, () const, EntityList), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QVariantList is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "QVariantList GetEntityIdsWithComponent(const QString &in) const", AS_METHOD_FUNCTION_PR(Scene, GetEntityIdsWithComponent, (const QString &) const, QVariantList), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(Entity * is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "Entity * GetEntityRaw(uint) const", AS_METHOD_FUNCTION_PR(Scene, GetEntityRaw, (uint) const, Entity *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(uint is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "bool DeleteEntityById(uint,AttributeChange::Type)", AS_METHOD_FUNCTION_PR(Scene, DeleteEntityById, (uint,AttributeChange::Type), bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(AttributeChange::Type is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "bool RemoveEntityRaw(int,AttributeChange::Type)", AS_METHOD_FUNCTION_PR(Scene, RemoveEntityRaw, (int,AttributeChange::Type), bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(EntityMap is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "EntityMap Entities()", AS_METHOD_FUNCTION_PR(Scene, Entities, (), EntityMap), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QByteArray is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "QByteArray GetEntityXml(Entity *) const", AS_METHOD_FUNCTION_PR(Scene, GetEntityXml, (Entity *) const, QByteArray), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);



	// /*(boost::shared_ptr< T > is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "boost::shared_ptr< T > GetComponent() const", AS_METHOD_FUNCTION_PR(Entity, GetComponent, () const, boost::shared_ptr< T >), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(ComponentPtr is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "ComponentPtr GetComponentById(component_id_t) const", AS_METHOD_FUNCTION_PR(Entity, GetComponentById, (component_id_t) const, ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ComponentPtr is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "ComponentPtr GetComponent(const QString &in) const", AS_METHOD_FUNCTION_PR(Entity, GetComponent, (const QString &) const, ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ComponentPtr is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "ComponentPtr GetComponent(u32) const", AS_METHOD_FUNCTION_PR(Entity, GetComponent, (u32) const, ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ComponentPtr is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "ComponentPtr GetComponent(const QString &in,const QString &in) const", AS_METHOD_FUNCTION_PR(Entity, GetComponent, (const QString &,const QString &) const, ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ComponentPtr is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "ComponentPtr GetComponent(u32,const QString &in) const", AS_METHOD_FUNCTION_PR(Entity, GetComponent, (u32,const QString &) const, ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ComponentPtr is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "ComponentPtr GetOrCreateComponent(const QString &in,AttributeChange::Type,bool)", AS_METHOD_FUNCTION_PR(Entity, GetOrCreateComponent, (const QString &,AttributeChange::Type,bool), ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ComponentPtr is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "ComponentPtr GetOrCreateComponent(const QString &in,const QString &in,AttributeChange::Type,bool)", AS_METHOD_FUNCTION_PR(Entity, GetOrCreateComponent, (const QString &,const QString &,AttributeChange::Type,bool), ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ComponentPtr is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "ComponentPtr GetOrCreateComponent(u32,AttributeChange::Type,bool)", AS_METHOD_FUNCTION_PR(Entity, GetOrCreateComponent, (u32,AttributeChange::Type,bool), ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ComponentPtr is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "ComponentPtr GetOrCreateComponent(u32,const QString &in,AttributeChange::Type,bool)", AS_METHOD_FUNCTION_PR(Entity, GetOrCreateComponent, (u32,const QString &,AttributeChange::Type,bool), ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ComponentPtr is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "ComponentPtr GetOrCreateLocalComponent(const QString &in)", AS_METHOD_FUNCTION_PR(Entity, GetOrCreateLocalComponent, (const QString &), ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ComponentPtr is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "ComponentPtr GetOrCreateLocalComponent(const QString &in,const QString &in)", AS_METHOD_FUNCTION_PR(Entity, GetOrCreateLocalComponent, (const QString &,const QString &), ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ComponentPtr is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "ComponentPtr CreateComponent(const QString &in,AttributeChange::Type,bool)", AS_METHOD_FUNCTION_PR(Entity, CreateComponent, (const QString &,AttributeChange::Type,bool), ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ComponentPtr is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "ComponentPtr CreateComponent(const QString &in,const QString &in,AttributeChange::Type,bool)", AS_METHOD_FUNCTION_PR(Entity, CreateComponent, (const QString &,const QString &,AttributeChange::Type,bool), ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ComponentPtr is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "ComponentPtr CreateComponent(u32,AttributeChange::Type,bool)", AS_METHOD_FUNCTION_PR(Entity, CreateComponent, (u32,AttributeChange::Type,bool), ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ComponentPtr is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "ComponentPtr CreateComponent(u32,const QString &in,AttributeChange::Type,bool)", AS_METHOD_FUNCTION_PR(Entity, CreateComponent, (u32,const QString &,AttributeChange::Type,bool), ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ComponentPtr is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "ComponentPtr CreateLocalComponent(const QString &in)", AS_METHOD_FUNCTION_PR(Entity, CreateLocalComponent, (const QString &), ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ComponentPtr is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "ComponentPtr CreateLocalComponent(const QString &in,const QString &in)", AS_METHOD_FUNCTION_PR(Entity, CreateLocalComponent, (const QString &,const QString &), ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ComponentPtr is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "void AddComponent(const ComponentPtr &in,AttributeChange::Type)", AS_METHOD_FUNCTION_PR(Entity, AddComponent, (const ComponentPtr &,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(component_id_t is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "void AddComponent(component_id_t,const ComponentPtr &in,AttributeChange::Type)", AS_METHOD_FUNCTION_PR(Entity, AddComponent, (component_id_t,const ComponentPtr &,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ComponentPtr is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "void RemoveComponent(const ComponentPtr &in,AttributeChange::Type)", AS_METHOD_FUNCTION_PR(Entity, RemoveComponent, (const ComponentPtr &,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QString is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "void RemoveComponent(const QString &in,AttributeChange::Type)", AS_METHOD_FUNCTION_PR(Entity, RemoveComponent, (const QString &,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QString is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "void RemoveComponent(const QString &in,const QString &in,AttributeChange::Type)", AS_METHOD_FUNCTION_PR(Entity, RemoveComponent, (const QString &,const QString &,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(component_id_t is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "void RemoveComponentById(component_id_t,AttributeChange::Type)", AS_METHOD_FUNCTION_PR(Entity, RemoveComponentById, (component_id_t,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ComponentVector is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "ComponentVector GetComponents(const QString &in) const", AS_METHOD_FUNCTION_PR(Entity, GetComponents, (const QString &) const, ComponentVector), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(EntityPtr is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "EntityPtr Clone(bool,bool) const", AS_METHOD_FUNCTION_PR(Entity, Clone, (bool,bool) const, EntityPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(QString is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "QString SerializeToXMLString(bool) const", AS_METHOD_FUNCTION_PR(Entity, SerializeToXMLString, (bool) const, QString), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QString is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "void SetName(const QString &in)", AS_METHOD_FUNCTION_PR(Entity, SetName, (const QString &), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QString is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "QString Name() const", AS_METHOD_FUNCTION_PR(Entity, Name, () const, QString), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QString is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "void SetDescription(const QString &in)", AS_METHOD_FUNCTION_PR(Entity, SetDescription, (const QString &), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QString is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "QString Description() const", AS_METHOD_FUNCTION_PR(Entity, Description, () const, QString), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(EntityAction * is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "EntityAction * Action(const QString &in)", AS_METHOD_FUNCTION_PR(Entity, Action, (const QString &), EntityAction *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QString is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "void RemoveAction(const QString &in)", AS_METHOD_FUNCTION_PR(Entity, RemoveAction, (const QString &), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QString is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "void ConnectAction(const QString &in,const QObject *,const char *)", AS_METHOD_FUNCTION_PR(Entity, ConnectAction, (const QString &,const QObject *,const char *), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(EntityAction::ExecTypeField is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "void Exec(EntityAction::ExecTypeField,const QString &in,const QString &in,const QString &in,const QString &in)", AS_METHOD_FUNCTION_PR(Entity, Exec, (EntityAction::ExecTypeField,const QString &,const QString &,const QString &,const QString &), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(EntityAction::ExecTypeField is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "void Exec(EntityAction::ExecTypeField,const QString &in,const QStringList &in)", AS_METHOD_FUNCTION_PR(Entity, Exec, (EntityAction::ExecTypeField,const QString &,const QStringList &), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(EntityAction::ExecTypeField is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "void Exec(EntityAction::ExecTypeField,const QString &in,const QVariantList &in)", AS_METHOD_FUNCTION_PR(Entity, Exec, (EntityAction::ExecTypeField,const QString &,const QVariantList &), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(QString is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "QString ToString() const", AS_METHOD_FUNCTION_PR(Entity, ToString, () const, QString), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QString is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "QString toString() const", AS_METHOD_FUNCTION_PR(Entity, toString, () const, QString), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(entity_id_t is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "entity_id_t Id() const", AS_METHOD_FUNCTION_PR(Entity, Id, () const, entity_id_t), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(Framework * is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "Framework * GetFramework() const", AS_METHOD_FUNCTION_PR(Entity, GetFramework, () const, Framework *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(Scene * is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "Scene * ParentScene() const", AS_METHOD_FUNCTION_PR(Entity, ParentScene, () const, Scene *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QObjectList is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "QObjectList ComponentsList() const", AS_METHOD_FUNCTION_PR(Entity, ComponentsList, () const, QObjectList), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QObjectList is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "QObjectList GetComponentsRaw(const QString &in) const", AS_METHOD_FUNCTION_PR(Entity, GetComponentsRaw, (const QString &) const, QObjectList), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QObject * is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "void RemoveComponentRaw(QObject *)", AS_METHOD_FUNCTION_PR(Entity, RemoveComponentRaw, (QObject *), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ComponentMap is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "ComponentMap Components()", AS_METHOD_FUNCTION_PR(Entity, Components, (), ComponentMap), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);



// /*(Scene * is not known to angelscript)*/ 		// /*(const QString & is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("IComponent", "const QString & TypeName() const", AS_METHOD_FUNCTION_PR(IComponent, TypeName, () const, const QString &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(Framework * is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("IComponent", "Framework * GetFramework() const", AS_METHOD_FUNCTION_PR(IComponent, GetFramework, () const, Framework *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(AttributeChange::Type is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("IComponent", "void SetUpdateMode(AttributeChange::Type)", AS_METHOD_FUNCTION_PR(IComponent, SetUpdateMode, (AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(AttributeChange::Type is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("IComponent", "AttributeChange::Type UpdateMode() const", AS_METHOD_FUNCTION_PR(IComponent, UpdateMode, () const, AttributeChange::Type), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(component_id_t is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("IComponent", "component_id_t Id() const", AS_METHOD_FUNCTION_PR(IComponent, Id, () const, component_id_t), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(IAttribute * is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("IComponent", "void EmitAttributeChanged(IAttribute *,AttributeChange::Type)", AS_METHOD_FUNCTION_PR(IComponent, EmitAttributeChanged, (IAttribute *,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QString is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("IComponent", "void EmitAttributeChanged(const QString &in,AttributeChange::Type)", AS_METHOD_FUNCTION_PR(IComponent, EmitAttributeChanged, (const QString &,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(AttributeChange::Type is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("IComponent", "void ComponentChanged(AttributeChange::Type)", AS_METHOD_FUNCTION_PR(IComponent, ComponentChanged, (AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(Entity * is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("IComponent", "Entity * ParentEntity() const", AS_METHOD_FUNCTION_PR(IComponent, ParentEntity, () const, Entity *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(Scene * is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("IComponent", "Scene * ParentScene() const", AS_METHOD_FUNCTION_PR(IComponent, ParentScene, () const, Scene *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(QVariant is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("IComponent", "QVariant GetAttributeQVariant(const QString &in) const", AS_METHOD_FUNCTION_PR(IComponent, GetAttributeQVariant, (const QString &) const, QVariant), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QStringList is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("IComponent", "QStringList GetAttributeNames() const", AS_METHOD_FUNCTION_PR(IComponent, GetAttributeNames, () const, QStringList), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(IComponent * is not known to angelscript)*/ 		// /*(IComponent * is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("IAttribute", "IComponent * Owner() const", AS_METHOD_FUNCTION_PR(IAttribute, Owner, () const, IComponent *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(Entity * is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("EC_Placeable", "void SetParent(Entity *,bool)", AS_METHOD_FUNCTION_PR(EC_Placeable, SetParent, (Entity *,bool), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(Entity * is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("EC_Placeable", "void SetParent(Entity *,QString,bool)", AS_METHOD_FUNCTION_PR(EC_Placeable, SetParent, (Entity *,QString,bool), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(EntityList is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("EC_Placeable", "EntityList Children() const", AS_METHOD_FUNCTION_PR(EC_Placeable, Children, () const, EntityList), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(Entity * is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("EC_Placeable", "Entity * ParentPlaceableEntity() const", AS_METHOD_FUNCTION_PR(EC_Placeable, ParentPlaceableEntity, () const, Entity *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(EC_Placeable * is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("EC_Placeable", "EC_Placeable * ParentPlaceableComponent() const", AS_METHOD_FUNCTION_PR(EC_Placeable, ParentPlaceableComponent, () const, EC_Placeable *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(Entity * is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("EC_Placeable", "bool IsGrandparentOf(Entity *) const", AS_METHOD_FUNCTION_PR(EC_Placeable, IsGrandparentOf, (Entity *) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(EC_Placeable * is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("EC_Placeable", "bool IsGrandparentOf(EC_Placeable *) const", AS_METHOD_FUNCTION_PR(EC_Placeable, IsGrandparentOf, (EC_Placeable *) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(Entity * is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("EC_Placeable", "bool IsGrandchildOf(Entity *) const", AS_METHOD_FUNCTION_PR(EC_Placeable, IsGrandchildOf, (Entity *) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(EC_Placeable * is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("EC_Placeable", "bool IsGrandchildOf(EC_Placeable *) const", AS_METHOD_FUNCTION_PR(EC_Placeable, IsGrandchildOf, (EC_Placeable *) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(EntityList is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("EC_Placeable", "EntityList Grandchildren(Entity *) const", AS_METHOD_FUNCTION_PR(EC_Placeable, Grandchildren, (Entity *) const, EntityList), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
