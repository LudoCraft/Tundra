...
// /*(QString(==QString) is not known to angelscript)*/ 	//.classmethod(// /*(u32(==boost::uint32_t) is not known to angelscript)*/ 	//.classmethod(// /*(u32 (==boost::uint32_t) is not known to angelscript)*/ 	//.classmethod(// /*(const QString & (==const QString &) is not known to angelscript)*/ 	//.classmethod(// /*(QStringList(==QStringList) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("SceneAPI", "QStringList ComponentTypes() const", AS_METHOD_FUNCTION_PR(SceneAPI, ComponentTypes, () const, QStringList), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(AttributeChange::Type (==AttributeChange::Type) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "void EmitAttributeChanged(IComponent @,IAttribute @,AttributeChange::Type)", AS_METHOD_FUNCTION_PR(Scene, EmitAttributeChanged, (IComponent *,IAttribute *,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(AttributeChange::Type (==AttributeChange::Type) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "void EmitAttributeAdded(IComponent @,IAttribute @,AttributeChange::Type)", AS_METHOD_FUNCTION_PR(Scene, EmitAttributeAdded, (IComponent *,IAttribute *,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(AttributeChange::Type (==AttributeChange::Type) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "void EmitAttributeRemoved(IComponent @,IAttribute @,AttributeChange::Type)", AS_METHOD_FUNCTION_PR(Scene, EmitAttributeRemoved, (IComponent *,IAttribute *,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(AttributeChange::Type (==AttributeChange::Type) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "void EmitComponentAdded(Entity @,IComponent @,AttributeChange::Type)", AS_METHOD_FUNCTION_PR(Scene, EmitComponentAdded, (Entity *,IComponent *,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(AttributeChange::Type (==AttributeChange::Type) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "void EmitComponentRemoved(Entity @,IComponent @,AttributeChange::Type)", AS_METHOD_FUNCTION_PR(Scene, EmitComponentRemoved, (Entity *,IComponent *,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(AttributeChange::Type (==AttributeChange::Type) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "void EmitEntityRemoved(Entity @,AttributeChange::Type)", AS_METHOD_FUNCTION_PR(Scene, EmitEntityRemoved, (Entity *,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const QString & (==const QString &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "void EmitActionTriggered(Entity @,const QString &in,const QStringList &in,EntityAction::ExecTypeField)", AS_METHOD_FUNCTION_PR(Scene, EmitActionTriggered, (Entity *,const QString &,const QStringList &,EntityAction::ExecTypeField), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(const QStringList & (==const QStringList &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "EntityPtr CreateEntity(uint,const QStringList &in,AttributeChange::Type,bool,bool)", AS_METHOD_FUNCTION_PR(Scene, CreateEntity, (entity_id_t,const QStringList &,AttributeChange::Type,bool,bool), EntityPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const QStringList & (==const QStringList &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "EntityPtr CreateLocalEntity(const QStringList &in,AttributeChange::Type,bool)", AS_METHOD_FUNCTION_PR(Scene, CreateLocalEntity, (const QStringList &,AttributeChange::Type,bool), EntityPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(AttributeChange::Type (==AttributeChange::Type) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "void EmitEntityCreated(Entity @,AttributeChange::Type)", AS_METHOD_FUNCTION_PR(Scene, EmitEntityCreated, (Entity *,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(AttributeChange::Type (==AttributeChange::Type) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("IComponent", "void EmitAttributeChanged(IAttribute @,AttributeChange::Type)", AS_METHOD_FUNCTION_PR(IComponent, EmitAttributeChanged, (IAttribute *,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(AttributeChange::Type (==AttributeChange::Type) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("IAttribute", "void CopyValue(IAttribute @,AttributeChange::Type)", AS_METHOD_FUNCTION_PR(IAttribute, CopyValue, (IAttribute *,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(AttributeChange::Type (==AttributeChange::Type) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("IAttribute", "void Interpolate(IAttribute @,IAttribute @,float,AttributeChange::Type)", AS_METHOD_FUNCTION_PR(IAttribute, Interpolate, (IAttribute *,IAttribute *,float,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
