...
// /*(Framework * (==Framework *) is not known to angelscript)*/ 	//.classmethod(// /*(Framework *(==Framework *) is not known to angelscript)*/ 	//.classmethod(// /*(StaticPluginRegistry *(==StaticPluginRegistry *) is not known to angelscript)*/ 	//.classmethod(// /*(UiAPI *(==UiAPI *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Framework", "UiAPI * Ui() const", AS_METHOD_FUNCTION_PR(Framework, Ui, () const, UiAPI *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(SceneAPI *(==SceneAPI *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Framework", "SceneAPI * Scene() const", AS_METHOD_FUNCTION_PR(Framework, Scene, () const, SceneAPI *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(QStringList(==QStringList) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Framework", "QStringList CommandLineParameters(const QString &in) const", AS_METHOD_FUNCTION_PR(Framework, CommandLineParameters, (const QString &) const, QStringList), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	...
	// /*(boost::shared_ptr< T >(==boost::shared_ptr< T >) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("SceneAPI", "boost::shared_ptr< T > CreateComponent(Scene *,const QString &in) const", AS_METHOD_FUNCTION_PR(SceneAPI, CreateComponent, (Scene *,const QString &) const, boost::shared_ptr< T >), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(const QStringList &(==const QStringList &) is not known to angelscript)*/ 	//.classmethod(// /*(ScenePtr(==boost::shared_ptr<Scene>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("SceneAPI", "boost::shared_ptr<Scene> GetScene(const QString &in) const", AS_METHOD_FUNCTION_PR(SceneAPI, GetScene, (const QString &) const, ScenePtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(Scene *(==Scene *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("SceneAPI", "Scene * MainCameraScene()", AS_METHOD_FUNCTION_PR(SceneAPI, MainCameraScene, (), Scene *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ScenePtr(==boost::shared_ptr<Scene>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("SceneAPI", "boost::shared_ptr<Scene> CreateScene(const QString &in,bool,bool)", AS_METHOD_FUNCTION_PR(SceneAPI, CreateScene, (const QString &,bool,bool), ScenePtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(ComponentPtr(==boost::shared_ptr<IComponent>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("SceneAPI", "boost::shared_ptr<IComponent> CreateComponentByName(Scene *,const QString &in,const QString &in) const", AS_METHOD_FUNCTION_PR(SceneAPI, CreateComponentByName, (Scene *,const QString &,const QString &) const, ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ComponentPtr(==boost::shared_ptr<IComponent>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("SceneAPI", "boost::shared_ptr<IComponent> CreateComponentById(Scene *,boost::uint32_t,const QString &in) const", AS_METHOD_FUNCTION_PR(SceneAPI, CreateComponentById, (Scene *,u32,const QString &) const, ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QString(==QString) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("SceneAPI", "QString GetComponentTypeName(boost::uint32_t) const", AS_METHOD_FUNCTION_PR(SceneAPI, GetComponentTypeName, (u32) const, QString), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(u32(==boost::uint32_t) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("SceneAPI", "boost::uint32_t GetComponentTypeId(const QString &in) const", AS_METHOD_FUNCTION_PR(SceneAPI, GetComponentTypeId, (const QString &) const, u32), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QString(==QString) is not known to angelscript)*/ 	//.classmethod(// /*(u32(==boost::uint32_t) is not known to angelscript)*/ 	//.classmethod(// /*(IAttribute *(==IAttribute *) is not known to angelscript)*/ 	//.classmethod(// /*(IAttribute *(==IAttribute *) is not known to angelscript)*/ 	//.classmethod(// /*(QStringList(==QStringList) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("SceneAPI", "QStringList ComponentTypes() const", AS_METHOD_FUNCTION_PR(SceneAPI, ComponentTypes, () const, QStringList), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(iterator(==EntityMap::iterator) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "EntityMap::iterator begin()", AS_METHOD_FUNCTION_PR(Scene, begin, (), iterator), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(iterator(==EntityMap::iterator) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "EntityMap::iterator end()", AS_METHOD_FUNCTION_PR(Scene, end, (), iterator), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const_iterator(==EntityMap::const_iterator) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "EntityMap::const_iterator begin() const", AS_METHOD_FUNCTION_PR(Scene, begin, () const, const_iterator), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const_iterator(==EntityMap::const_iterator) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "EntityMap::const_iterator end() const", AS_METHOD_FUNCTION_PR(Scene, end, () const, const_iterator), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(boost::shared_ptr< T >(==boost::shared_ptr< T >) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "boost::shared_ptr< T > GetWorld() const", AS_METHOD_FUNCTION_PR(Scene, GetWorld, () const, boost::shared_ptr< T >), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(IAttribute * (==IAttribute *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "bool StartAttributeInterpolation(IAttribute *,IAttribute *,float)", AS_METHOD_FUNCTION_PR(Scene, StartAttributeInterpolation, (IAttribute *,IAttribute *,float), bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(IAttribute * (==IAttribute *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "bool EndAttributeInterpolation(IAttribute *)", AS_METHOD_FUNCTION_PR(Scene, EndAttributeInterpolation, (IAttribute *), bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(Framework *(==Framework *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "Framework * GetFramework() const", AS_METHOD_FUNCTION_PR(Scene, GetFramework, () const, Framework *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(QList< Entity * >(==QList< Entity * >) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "QList< Entity * > CreateContentFromSceneDesc(const SceneDesc &in,bool,AttributeChange::Type)", AS_METHOD_FUNCTION_PR(Scene, CreateContentFromSceneDesc, (const SceneDesc &,bool,AttributeChange::Type), QList< Entity * >), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(IComponent * (==IComponent *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "void EmitAttributeChanged(IComponent *,IAttribute *,AttributeChange::Type)", AS_METHOD_FUNCTION_PR(Scene, EmitAttributeChanged, (IComponent *,IAttribute *,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(IComponent * (==IComponent *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "void EmitAttributeAdded(IComponent *,IAttribute *,AttributeChange::Type)", AS_METHOD_FUNCTION_PR(Scene, EmitAttributeAdded, (IComponent *,IAttribute *,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(IComponent * (==IComponent *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "void EmitAttributeRemoved(IComponent *,IAttribute *,AttributeChange::Type)", AS_METHOD_FUNCTION_PR(Scene, EmitAttributeRemoved, (IComponent *,IAttribute *,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(Entity * (==Entity *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "void EmitComponentAdded(Entity *,IComponent *,AttributeChange::Type)", AS_METHOD_FUNCTION_PR(Scene, EmitComponentAdded, (Entity *,IComponent *,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(Entity * (==Entity *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "void EmitComponentRemoved(Entity *,IComponent *,AttributeChange::Type)", AS_METHOD_FUNCTION_PR(Scene, EmitComponentRemoved, (Entity *,IComponent *,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(Entity * (==Entity *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "void EmitEntityRemoved(Entity *,AttributeChange::Type)", AS_METHOD_FUNCTION_PR(Scene, EmitEntityRemoved, (Entity *,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(Entity * (==Entity *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "void EmitActionTriggered(Entity *,const QString &in,const QStringList &in,EntityAction::ExecTypeField)", AS_METHOD_FUNCTION_PR(Scene, EmitActionTriggered, (Entity *,const QString &,const QStringList &,EntityAction::ExecTypeField), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(Entity * (==Entity *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "void EmitEntityAcked(Entity *,uint)", AS_METHOD_FUNCTION_PR(Scene, EmitEntityAcked, (Entity *,entity_id_t), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(IComponent * (==IComponent *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "void EmitComponentAcked(IComponent *,uint)", AS_METHOD_FUNCTION_PR(Scene, EmitComponentAcked, (IComponent *,component_id_t), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(EntityPtr(==boost::shared_ptr<Entity>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "boost::shared_ptr<Entity> CreateEntity(uint,const QStringList &in,AttributeChange::Type,bool,bool)", AS_METHOD_FUNCTION_PR(Scene, CreateEntity, (entity_id_t,const QStringList &,AttributeChange::Type,bool,bool), EntityPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(EntityPtr(==boost::shared_ptr<Entity>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "boost::shared_ptr<Entity> CreateLocalEntity(const QStringList &in,AttributeChange::Type,bool)", AS_METHOD_FUNCTION_PR(Scene, CreateLocalEntity, (const QStringList &,AttributeChange::Type,bool), EntityPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(EntityPtr(==boost::shared_ptr<Entity>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "boost::shared_ptr<Entity> EntityById(uint) const", AS_METHOD_FUNCTION_PR(Scene, EntityById, (entity_id_t) const, EntityPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(EntityPtr(==boost::shared_ptr<Entity>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "boost::shared_ptr<Entity> EntityByName(const QString &in) const", AS_METHOD_FUNCTION_PR(Scene, EntityByName, (const QString &) const, EntityPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(AttributeChange::Type (==AttributeChange::Type) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "bool RemoveEntity(uint,AttributeChange::Type)", AS_METHOD_FUNCTION_PR(Scene, RemoveEntity, (entity_id_t,AttributeChange::Type), bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(AttributeChange::Type (==AttributeChange::Type) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "void RemoveAllEntities(bool,AttributeChange::Type)", AS_METHOD_FUNCTION_PR(Scene, RemoveAllEntities, (bool,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(EntityList(==std::list<EntityPtr>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "std::list<EntityPtr> EntitiesWithComponent(const QString &in,const QString &in) const", AS_METHOD_FUNCTION_PR(Scene, EntitiesWithComponent, (const QString &,const QString &) const, EntityList), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(EntityList(==std::list<EntityPtr>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "std::list<EntityPtr> FindEntities(const QRegExp &in) const", AS_METHOD_FUNCTION_PR(Scene, FindEntities, (const QRegExp &) const, EntityList), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(EntityList(==std::list<EntityPtr>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "std::list<EntityPtr> FindEntities(const QString &in) const", AS_METHOD_FUNCTION_PR(Scene, FindEntities, (const QString &) const, EntityList), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(EntityList(==std::list<EntityPtr>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "std::list<EntityPtr> FindEntitiesContaining(const QString &in) const", AS_METHOD_FUNCTION_PR(Scene, FindEntitiesContaining, (const QString &) const, EntityList), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QList< Entity * >(==QList< Entity * >) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "QList< Entity * > LoadSceneXML(const QString &in,bool,bool,AttributeChange::Type)", AS_METHOD_FUNCTION_PR(Scene, LoadSceneXML, (const QString &,bool,bool,AttributeChange::Type), QList< Entity * >), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(QList< Entity * >(==QList< Entity * >) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "QList< Entity * > CreateContentFromXml(const QString &in,bool,AttributeChange::Type)", AS_METHOD_FUNCTION_PR(Scene, CreateContentFromXml, (const QString &,bool,AttributeChange::Type), QList< Entity * >), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QList< Entity * >(==QList< Entity * >) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "QList< Entity * > CreateContentFromXml(const QDomDocument &in,bool,AttributeChange::Type)", AS_METHOD_FUNCTION_PR(Scene, CreateContentFromXml, (const QDomDocument &,bool,AttributeChange::Type), QList< Entity * >), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QList< Entity * >(==QList< Entity * >) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "QList< Entity * > CreateContentFromBinary(const QString &in,bool,AttributeChange::Type)", AS_METHOD_FUNCTION_PR(Scene, CreateContentFromBinary, (const QString &,bool,AttributeChange::Type), QList< Entity * >), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QList< Entity * >(==QList< Entity * >) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "QList< Entity * > CreateContentFromBinary(const int8 *,int,bool,AttributeChange::Type)", AS_METHOD_FUNCTION_PR(Scene, CreateContentFromBinary, (const char *,int,bool,AttributeChange::Type), QList< Entity * >), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(Entity * (==Entity *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "void EmitEntityCreated(Entity *,AttributeChange::Type)", AS_METHOD_FUNCTION_PR(Scene, EmitEntityCreated, (Entity *,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(EntityPtr(==boost::shared_ptr<Entity>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "boost::shared_ptr<Entity> GetEntity(uint) const", AS_METHOD_FUNCTION_PR(Scene, GetEntity, (entity_id_t) const, EntityPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(EntityPtr(==boost::shared_ptr<Entity>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "boost::shared_ptr<Entity> GetEntityByName(const QString &in) const", AS_METHOD_FUNCTION_PR(Scene, GetEntityByName, (const QString &) const, EntityPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(EntityList(==std::list<EntityPtr>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "std::list<EntityPtr> GetEntitiesWithComponent(const QString &in,const QString &in) const", AS_METHOD_FUNCTION_PR(Scene, GetEntitiesWithComponent, (const QString &,const QString &) const, EntityList), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(EntityList(==std::list<EntityPtr>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "std::list<EntityPtr> GetAllEntities() const", AS_METHOD_FUNCTION_PR(Scene, GetAllEntities, () const, EntityList), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(Entity *(==Entity *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "Entity * GetEntityRaw(uint) const", AS_METHOD_FUNCTION_PR(Scene, GetEntityRaw, (uint) const, Entity *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(AttributeChange::Type (==AttributeChange::Type) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "bool DeleteEntityById(uint,AttributeChange::Type)", AS_METHOD_FUNCTION_PR(Scene, DeleteEntityById, (uint,AttributeChange::Type), bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(AttributeChange::Type (==AttributeChange::Type) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "bool RemoveEntityRaw(int,AttributeChange::Type)", AS_METHOD_FUNCTION_PR(Scene, RemoveEntityRaw, (int,AttributeChange::Type), bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(EntityMap(==std::map<entity_id_t, EntityPtr>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "std::map<entity_id_t, EntityPtr> Entities()", AS_METHOD_FUNCTION_PR(Scene, Entities, (), EntityMap), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(QByteArray(==QByteArray) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Scene", "QByteArray GetEntityXml(Entity *) const", AS_METHOD_FUNCTION_PR(Scene, GetEntityXml, (Entity *) const, QByteArray), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
	...
	// /*(boost::shared_ptr< T >(==boost::shared_ptr< T >) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "boost::shared_ptr< T > GetComponent() const", AS_METHOD_FUNCTION_PR(Entity, GetComponent, () const, boost::shared_ptr< T >), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(std::vector< boost::shared_ptr< T > >(==std::vector< boost::shared_ptr< T > >) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "std::vector< boost::shared_ptr< T > > GetComponents() const", AS_METHOD_FUNCTION_PR(Entity, GetComponents, () const, std::vector< boost::shared_ptr< T > >), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(boost::shared_ptr< T >(==boost::shared_ptr< T >) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "boost::shared_ptr< T > GetComponent(const QString &in) const", AS_METHOD_FUNCTION_PR(Entity, GetComponent, (const QString &) const, boost::shared_ptr< T >), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(std::vector< Attribute < T > >(==std::vector< Attribute < T > >) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "std::vector< Attribute < T > > GetAttributes(const QString &in) const", AS_METHOD_FUNCTION_PR(Entity, GetAttributes, (const QString &) const, std::vector< Attribute < T > >), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(IComponent * (==IComponent *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "void EmitEnterView(IComponent *)", AS_METHOD_FUNCTION_PR(Entity, EmitEnterView, (IComponent *), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(IComponent * (==IComponent *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "void EmitLeaveView(IComponent *)", AS_METHOD_FUNCTION_PR(Entity, EmitLeaveView, (IComponent *), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(ComponentPtr(==boost::shared_ptr<IComponent>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "boost::shared_ptr<IComponent> CreateComponentWithId(uint,boost::uint32_t,const QString &in,AttributeChange::Type)", AS_METHOD_FUNCTION_PR(Entity, CreateComponentWithId, (component_id_t,u32,const QString &,AttributeChange::Type), ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(IAttribute *(==IAttribute *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "IAttribute * GetAttribute(const QString &in) const", AS_METHOD_FUNCTION_PR(Entity, GetAttribute, (const QString &) const, IAttribute *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(AttributeVector(==std::vector<IAttribute*>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "std::vector<IAttribute*> GetAttributes(const QString &in) const", AS_METHOD_FUNCTION_PR(Entity, GetAttributes, (const QString &) const, AttributeVector), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(ComponentPtr(==boost::shared_ptr<IComponent>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "boost::shared_ptr<IComponent> GetComponentById(uint) const", AS_METHOD_FUNCTION_PR(Entity, GetComponentById, (component_id_t) const, ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ComponentPtr(==boost::shared_ptr<IComponent>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "boost::shared_ptr<IComponent> GetComponent(const QString &in) const", AS_METHOD_FUNCTION_PR(Entity, GetComponent, (const QString &) const, ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ComponentPtr(==boost::shared_ptr<IComponent>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "boost::shared_ptr<IComponent> GetComponent(boost::uint32_t) const", AS_METHOD_FUNCTION_PR(Entity, GetComponent, (u32) const, ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ComponentPtr(==boost::shared_ptr<IComponent>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "boost::shared_ptr<IComponent> GetComponent(const QString &in,const QString &in) const", AS_METHOD_FUNCTION_PR(Entity, GetComponent, (const QString &,const QString &) const, ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ComponentPtr(==boost::shared_ptr<IComponent>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "boost::shared_ptr<IComponent> GetComponent(boost::uint32_t,const QString &in) const", AS_METHOD_FUNCTION_PR(Entity, GetComponent, (u32,const QString &) const, ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ComponentPtr(==boost::shared_ptr<IComponent>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "boost::shared_ptr<IComponent> GetOrCreateComponent(const QString &in,AttributeChange::Type,bool)", AS_METHOD_FUNCTION_PR(Entity, GetOrCreateComponent, (const QString &,AttributeChange::Type,bool), ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ComponentPtr(==boost::shared_ptr<IComponent>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "boost::shared_ptr<IComponent> GetOrCreateComponent(const QString &in,const QString &in,AttributeChange::Type,bool)", AS_METHOD_FUNCTION_PR(Entity, GetOrCreateComponent, (const QString &,const QString &,AttributeChange::Type,bool), ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ComponentPtr(==boost::shared_ptr<IComponent>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "boost::shared_ptr<IComponent> GetOrCreateComponent(boost::uint32_t,AttributeChange::Type,bool)", AS_METHOD_FUNCTION_PR(Entity, GetOrCreateComponent, (u32,AttributeChange::Type,bool), ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ComponentPtr(==boost::shared_ptr<IComponent>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "boost::shared_ptr<IComponent> GetOrCreateComponent(boost::uint32_t,const QString &in,AttributeChange::Type,bool)", AS_METHOD_FUNCTION_PR(Entity, GetOrCreateComponent, (u32,const QString &,AttributeChange::Type,bool), ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ComponentPtr(==boost::shared_ptr<IComponent>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "boost::shared_ptr<IComponent> GetOrCreateLocalComponent(const QString &in)", AS_METHOD_FUNCTION_PR(Entity, GetOrCreateLocalComponent, (const QString &), ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ComponentPtr(==boost::shared_ptr<IComponent>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "boost::shared_ptr<IComponent> GetOrCreateLocalComponent(const QString &in,const QString &in)", AS_METHOD_FUNCTION_PR(Entity, GetOrCreateLocalComponent, (const QString &,const QString &), ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ComponentPtr(==boost::shared_ptr<IComponent>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "boost::shared_ptr<IComponent> CreateComponent(const QString &in,AttributeChange::Type,bool)", AS_METHOD_FUNCTION_PR(Entity, CreateComponent, (const QString &,AttributeChange::Type,bool), ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ComponentPtr(==boost::shared_ptr<IComponent>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "boost::shared_ptr<IComponent> CreateComponent(const QString &in,const QString &in,AttributeChange::Type,bool)", AS_METHOD_FUNCTION_PR(Entity, CreateComponent, (const QString &,const QString &,AttributeChange::Type,bool), ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ComponentPtr(==boost::shared_ptr<IComponent>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "boost::shared_ptr<IComponent> CreateComponent(boost::uint32_t,AttributeChange::Type,bool)", AS_METHOD_FUNCTION_PR(Entity, CreateComponent, (u32,AttributeChange::Type,bool), ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ComponentPtr(==boost::shared_ptr<IComponent>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "boost::shared_ptr<IComponent> CreateComponent(boost::uint32_t,const QString &in,AttributeChange::Type,bool)", AS_METHOD_FUNCTION_PR(Entity, CreateComponent, (u32,const QString &,AttributeChange::Type,bool), ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ComponentPtr(==boost::shared_ptr<IComponent>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "boost::shared_ptr<IComponent> CreateLocalComponent(const QString &in)", AS_METHOD_FUNCTION_PR(Entity, CreateLocalComponent, (const QString &), ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ComponentPtr(==boost::shared_ptr<IComponent>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "boost::shared_ptr<IComponent> CreateLocalComponent(const QString &in,const QString &in)", AS_METHOD_FUNCTION_PR(Entity, CreateLocalComponent, (const QString &,const QString &), ComponentPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const ComponentPtr & (==const ComponentPtr &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "void AddComponent(const ComponentPtr &in,AttributeChange::Type)", AS_METHOD_FUNCTION_PR(Entity, AddComponent, (const ComponentPtr &,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const ComponentPtr & (==const ComponentPtr &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "void AddComponent(uint,const ComponentPtr &in,AttributeChange::Type)", AS_METHOD_FUNCTION_PR(Entity, AddComponent, (component_id_t,const ComponentPtr &,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const ComponentPtr & (==const ComponentPtr &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "void RemoveComponent(const ComponentPtr &in,AttributeChange::Type)", AS_METHOD_FUNCTION_PR(Entity, RemoveComponent, (const ComponentPtr &,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const QString & (==const QString &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "void RemoveComponent(const QString &in,AttributeChange::Type)", AS_METHOD_FUNCTION_PR(Entity, RemoveComponent, (const QString &,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const QString & (==const QString &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "void RemoveComponent(const QString &in,const QString &in,AttributeChange::Type)", AS_METHOD_FUNCTION_PR(Entity, RemoveComponent, (const QString &,const QString &,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(AttributeChange::Type (==AttributeChange::Type) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "void RemoveComponentById(uint,AttributeChange::Type)", AS_METHOD_FUNCTION_PR(Entity, RemoveComponentById, (component_id_t,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(ComponentVector(==std::vector<ComponentPtr>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "std::vector<ComponentPtr> GetComponents(const QString &in) const", AS_METHOD_FUNCTION_PR(Entity, GetComponents, (const QString &) const, ComponentVector), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(EntityPtr(==boost::shared_ptr<Entity>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "boost::shared_ptr<Entity> Clone(bool,bool) const", AS_METHOD_FUNCTION_PR(Entity, Clone, (bool,bool) const, EntityPtr), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(EntityAction::ExecTypeField (==EntityAction::ExecTypeField) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "void Exec(EntityAction::ExecTypeField,const QString &in,const QString &in,const QString &in,const QString &in)", AS_METHOD_FUNCTION_PR(Entity, Exec, (EntityAction::ExecTypeField,const QString &,const QString &,const QString &,const QString &), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(EntityAction::ExecTypeField (==EntityAction::ExecTypeField) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "void Exec(EntityAction::ExecTypeField,const QString &in,const QStringList &in)", AS_METHOD_FUNCTION_PR(Entity, Exec, (EntityAction::ExecTypeField,const QString &,const QStringList &), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(EntityAction::ExecTypeField (==EntityAction::ExecTypeField) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "void Exec(EntityAction::ExecTypeField,const QString &in,const QVariantList &in)", AS_METHOD_FUNCTION_PR(Entity, Exec, (EntityAction::ExecTypeField,const QString &,const QVariantList &), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(Framework *(==Framework *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "Framework * GetFramework() const", AS_METHOD_FUNCTION_PR(Entity, GetFramework, () const, Framework *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(Scene *(==Scene *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "Scene * ParentScene() const", AS_METHOD_FUNCTION_PR(Entity, ParentScene, () const, Scene *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(ComponentMap(==std::map<component_id_t, ComponentPtr>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Entity", "std::map<component_id_t, ComponentPtr> Components()", AS_METHOD_FUNCTION_PR(Entity, Components, (), ComponentMap), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);



// /*(Scene * (==Scene *) is not known to angelscript)*/ 		// /*(const QString &(==const QString &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("IComponent", "const QString & TypeName() const", AS_METHOD_FUNCTION_PR(IComponent, TypeName, () const, const QString &), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(u32(==boost::uint32_t) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("IComponent", "boost::uint32_t TypeId() const", AS_METHOD_FUNCTION_PR(IComponent, TypeId, () const, u32), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(Entity * (==Entity *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("IComponent", "void SetParentEntity(Entity *)", AS_METHOD_FUNCTION_PR(IComponent, SetParentEntity, (Entity *), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(AttributeVector(==std::vector<IAttribute*>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("IComponent", "std::vector<IAttribute*> NonEmptyAttributes() const", AS_METHOD_FUNCTION_PR(IComponent, NonEmptyAttributes, () const, AttributeVector), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(IAttribute *(==IAttribute *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("IComponent", "IAttribute * GetAttribute(const QString &in) const", AS_METHOD_FUNCTION_PR(IComponent, GetAttribute, (const QString &) const, IAttribute *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(IAttribute *(==IAttribute *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("IComponent", "IAttribute * CreateAttribute(uint8,boost::uint32_t,const QString &in,AttributeChange::Type)", AS_METHOD_FUNCTION_PR(IComponent, CreateAttribute, (u8,u32,const QString &,AttributeChange::Type), IAttribute *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(AttributeChange::Type (==AttributeChange::Type) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("IComponent", "void RemoveAttribute(uint8,AttributeChange::Type)", AS_METHOD_FUNCTION_PR(IComponent, RemoveAttribute, (u8,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(Framework *(==Framework *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("IComponent", "Framework * GetFramework() const", AS_METHOD_FUNCTION_PR(IComponent, GetFramework, () const, Framework *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(AttributeChange::Type (==AttributeChange::Type) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("IComponent", "void SetUpdateMode(AttributeChange::Type)", AS_METHOD_FUNCTION_PR(IComponent, SetUpdateMode, (AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(AttributeChange::Type(==AttributeChange::Type) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("IComponent", "AttributeChange::Type UpdateMode() const", AS_METHOD_FUNCTION_PR(IComponent, UpdateMode, () const, AttributeChange::Type), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(IAttribute * (==IAttribute *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("IComponent", "void EmitAttributeChanged(IAttribute *,AttributeChange::Type)", AS_METHOD_FUNCTION_PR(IComponent, EmitAttributeChanged, (IAttribute *,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const QString & (==const QString &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("IComponent", "void EmitAttributeChanged(const QString &in,AttributeChange::Type)", AS_METHOD_FUNCTION_PR(IComponent, EmitAttributeChanged, (const QString &,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(AttributeChange::Type (==AttributeChange::Type) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("IComponent", "void ComponentChanged(AttributeChange::Type)", AS_METHOD_FUNCTION_PR(IComponent, ComponentChanged, (AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(Entity *(==Entity *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("IComponent", "Entity * ParentEntity() const", AS_METHOD_FUNCTION_PR(IComponent, ParentEntity, () const, Entity *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(Scene *(==Scene *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("IComponent", "Scene * ParentScene() const", AS_METHOD_FUNCTION_PR(IComponent, ParentScene, () const, Scene *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(IComponent * (==IComponent *) is not known to angelscript)*/ 		// /*(IComponent *(==IComponent *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("IAttribute", "IComponent * Owner() const", AS_METHOD_FUNCTION_PR(IAttribute, Owner, () const, IComponent *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(AttributeChange::Type (==AttributeChange::Type) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("IAttribute", "void FromString(const string &in,AttributeChange::Type)", AS_METHOD_FUNCTION_PR(IAttribute, FromString, (const std::string &,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(u32(==boost::uint32_t) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("IAttribute", "boost::uint32_t TypeId() const", AS_METHOD_FUNCTION_PR(IAttribute, TypeId, () const, u32), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(const QVariant & (==const QVariant &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("IAttribute", "void FromQVariant(const QVariant &in,AttributeChange::Type)", AS_METHOD_FUNCTION_PR(IAttribute, FromQVariant, (const QVariant &,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(const QScriptValue & (==const QScriptValue &) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("IAttribute", "void FromScriptValue(const QScriptValue &in,AttributeChange::Type)", AS_METHOD_FUNCTION_PR(IAttribute, FromScriptValue, (const QScriptValue &,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(AttributeChange::Type (==AttributeChange::Type) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("IAttribute", "void Changed(AttributeChange::Type)", AS_METHOD_FUNCTION_PR(IAttribute, Changed, (AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(IAttribute *(==IAttribute *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("IAttribute", "IAttribute * Clone() const", AS_METHOD_FUNCTION_PR(IAttribute, Clone, () const, IAttribute *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(IAttribute * (==IAttribute *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("IAttribute", "void CopyValue(IAttribute *,AttributeChange::Type)", AS_METHOD_FUNCTION_PR(IAttribute, CopyValue, (IAttribute *,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(IAttribute * (==IAttribute *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("IAttribute", "void Interpolate(IAttribute *,IAttribute *,float,AttributeChange::Type)", AS_METHOD_FUNCTION_PR(IAttribute, Interpolate, (IAttribute *,IAttribute *,float,AttributeChange::Type), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(std::vector< float3 >(==std::vector< float3 >) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Circle", "std::vector< float3 > IntersectsFaces(const OBB &in) const", AS_METHOD_FUNCTION_PR(Circle, IntersectsFaces, (const OBB &) const, std::vector< float3 >), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(std::vector< float3 >(==std::vector< float3 >) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("Circle", "std::vector< float3 > IntersectsFaces(const AABB &in) const", AS_METHOD_FUNCTION_PR(Circle, IntersectsFaces, (const AABB &) const, std::vector< float3 >), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(u32 (==boost::uint32_t) is not known to angelscript)*/ 	r = engine->RegisterObjectBehaviour("LCG", asBEHAVE_CONSTRUCT, "void f(boost::uint32_t,boost::uint32_t,boost::uint32_t,boost::uint32_t)", AS_CONSTRUCTOR(LCG_ctor_u32_u32_u32_u32, LCG, (u32,u32,u32,u32)), AS_CTOR_CONVENTION); assert(r >= 0);
// /*(u32 (==boost::uint32_t) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("LCG", "void Seed(boost::uint32_t,boost::uint32_t,boost::uint32_t,boost::uint32_t)", AS_METHOD_FUNCTION_PR(LCG, Seed, (u32,u32,u32,u32), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(u32(==boost::uint32_t) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("LCG", "boost::uint32_t Int()", AS_METHOD_FUNCTION_PR(LCG, Int, (), u32), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(u32(==boost::uint32_t) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("LCG", "boost::uint32_t MaxInt() const", AS_METHOD_FUNCTION_PR(LCG, MaxInt, () const, u32), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(u32(==boost::uint32_t) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("LCG", "boost::uint32_t IntFast()", AS_METHOD_FUNCTION_PR(LCG, IntFast, (), u32), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(Scene * (==Scene *) is not known to angelscript)*/ 	r = engine->RegisterObjectBehaviour("EC_Placeable", asBEHAVE_FACTORY, "EC_Placeable@ f(Scene *)", AS_FUNCTION(EC_Placeable_ctor_Scene_ptr, EC_Placeable, (Scene *)), AS_CALL_CONVENTION); assert(r >= 0);	// /*(Ogre::SceneNode *(==Ogre::SceneNode *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("EC_Placeable", "Ogre::SceneNode * GetSceneNode() const", AS_METHOD_FUNCTION_PR(EC_Placeable, GetSceneNode, () const, Ogre::SceneNode *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(Entity * (==Entity *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("EC_Placeable", "void SetParent(Entity *,bool)", AS_METHOD_FUNCTION_PR(EC_Placeable, SetParent, (Entity *,bool), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(Entity * (==Entity *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("EC_Placeable", "void SetParent(Entity *,QString,bool)", AS_METHOD_FUNCTION_PR(EC_Placeable, SetParent, (Entity *,QString,bool), void), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(EntityList(==std::list<EntityPtr>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("EC_Placeable", "std::list<EntityPtr> Children() const", AS_METHOD_FUNCTION_PR(EC_Placeable, Children, () const, EntityList), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
...
// /*(Entity *(==Entity *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("EC_Placeable", "Entity * ParentPlaceableEntity() const", AS_METHOD_FUNCTION_PR(EC_Placeable, ParentPlaceableEntity, () const, Entity *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(EC_Placeable *(==EC_Placeable *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("EC_Placeable", "EC_Placeable * ParentPlaceableComponent() const", AS_METHOD_FUNCTION_PR(EC_Placeable, ParentPlaceableComponent, () const, EC_Placeable *), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(Entity * (==Entity *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("EC_Placeable", "bool IsGrandparentOf(Entity *) const", AS_METHOD_FUNCTION_PR(EC_Placeable, IsGrandparentOf, (Entity *) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(EC_Placeable * (==EC_Placeable *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("EC_Placeable", "bool IsGrandparentOf(EC_Placeable *) const", AS_METHOD_FUNCTION_PR(EC_Placeable, IsGrandparentOf, (EC_Placeable *) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(Entity * (==Entity *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("EC_Placeable", "bool IsGrandchildOf(Entity *) const", AS_METHOD_FUNCTION_PR(EC_Placeable, IsGrandchildOf, (Entity *) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(EC_Placeable * (==EC_Placeable *) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("EC_Placeable", "bool IsGrandchildOf(EC_Placeable *) const", AS_METHOD_FUNCTION_PR(EC_Placeable, IsGrandchildOf, (EC_Placeable *) const, bool), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
// /*(EntityList(==std::list<EntityPtr>) is not known to angelscript)*/ 	r = engine->RegisterObjectMethod("EC_Placeable", "std::list<EntityPtr> Grandchildren(Entity *) const", AS_METHOD_FUNCTION_PR(EC_Placeable, Grandchildren, (Entity *) const, EntityList), AS_MEMBER_CALL_CONVENTION); assert(r >= 0);
