...
macro(use_package_librocket)
    if ("${ENV_ASSIMP_DIR}" STREQUAL "")
        set(LIBROCKET_DIR ${ENV_TUNDRA_DEP_PATH}/libRocket)
    else ()
        message (STATUS "-- Using from env variable LIBROCKET_DIR")
        set(LIBROCKET_DIR ${ENV_LIBROCKET_DIR})
    endif()
    include_directories(${LIBROCKET_DIR}/Include)
    link_directories(${LIBROCKET_DIR}/bin)
endmacro()

macro(link_package_librocket)
    target_link_libraries(${TARGET_NAME} optimized RocketControls)
    target_link_libraries(${TARGET_NAME} optimized RocketCore)
    target_link_libraries(${TARGET_NAME} debug RocketControls_d)
    target_link_libraries(${TARGET_NAME} debug RocketCore_d)
endmacro()
